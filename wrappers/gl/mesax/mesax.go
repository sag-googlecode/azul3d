...
// 
// MESAX_texture_stack: http://www.opengl.org/registry/specs/MESAX/texture_stack.txt
// 
package mesax
...
func InitMesaxTextureStack() error {
	var ret C.int
	if ret = C.init_MESAX_texture_stack(); ret != 0 {
		return errors.New("unable to initialize MESAX_texture_stack")
	}
	return nil
}
// EOF