...
func program() {
	...
	t, err := renderer.LoadTextureFile(engine.Renderer, "src/azul3d.org/v1/assets/textures/panel.9.png")
	if err != nil {
		log.Fatal(err)
	}
	...
	t2, err := renderer.LoadTextureFile(engine.Renderer, "src/azul3d.org/v1/assets/textures/player.png")
	if err != nil {
		log.Fatal(err)
	}
