...
// 
// REND_screen_coordinates: http://www.opengl.org/registry/specs/REND/screen_coordinates.txt
// 
package rend
...
// //  REND_screen_coordinates
// 
// int init_REND_screen_coordinates() {
// 	return 0;
// }
// 
import "C"
...
func InitRendScreenCoordinates() error {
	var ret C.int
	if ret = C.init_REND_screen_coordinates(); ret != 0 {
		return errors.New("unable to initialize REND_screen_coordinates")
	}
	return nil
}
// EOF