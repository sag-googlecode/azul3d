...
type backend_resolution struct {
...
func newScreen(xScreen *c_Screen) (*Screen, error) {
	...
	s.origGammaRamp, _ = backend_gammaRamp(&s)
...
func backend_screens() ([]*Screen, error) {
    return globalScreens, nil
}

func backend_defaultScreen() (*Screen, error) {
    return globalDefaultScreen, nil
}

func initScreens() error {
	var err error
	globalDefaultScreen, err = defaultScreen()
	if err != nil {
		return err
	}
	globalScreens, err = screens()
	if err != nil {
		return err
	}
	return nil
