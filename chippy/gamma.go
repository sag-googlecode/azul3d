...
// SetGammaRamp sets the gamma to the Ramp specified
func (s *Screen) SetGammaRamp(ramp *Ramp) error {
	...
	return backend_setGammaRamp(s, ramp)
}

// GammaRamp returns the currently in use gamma Ramp for this Screen
func (s *Screen) GammaRamp() (*Ramp, error) {
	...
	return backend_gammaRamp(s)
}

// SetGammaRgb sets the gamma of this Screen as rgb float32
...
// GammaRgb returns the gamma of this Screen as rgb float32
...
// SetGamma sets the rgb gamma of this Screen as an float32
func (s *Screen) SetGamma(gamma float32) error {
	return s.SetGammaRgb(gamma, gamma, gamma)
}

// Gamma returns the gamma of this Screen as an float32
