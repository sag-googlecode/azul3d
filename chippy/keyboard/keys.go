...
func (k Key) String() string {
	switch(k) {
		...
		case NumZero: return "NumZero"
		case NumOne: return "NumOne"
		case NumTwo: return "NumTwo"
		case NumThree: return "NumThree"
		case NumFour: return "NumFour"
		case NumFive: return "NumFive"
		case NumSix: return "NumSix"
		case NumSeven: return "NumSeven"
		case NumEight: return "NumEight"
		case NumNine: return "NumNine"
		...
		case LaunchAppOne: return "LaunchAppOne"
		case LaunchAppTwo: return "LaunchAppTwo"
