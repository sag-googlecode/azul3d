...
typedef void(*gl121PTexImage3DEXT)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, GLvoid*);
...
typedef void(*gl121PTexSubImage3DEXT)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, GLvoid*);
...
typedef void(*gl121PBlendColorEXT)(GLclampf, GLclampf, GLclampf, GLclampf);
...
typedef struct {
    ...
    gl121PTexImage3DEXT fnTexImage3DEXT;
    ...
    gl121PTexSubImage3DEXT fnTexSubImage3DEXT;
    ...
    gl121PBlendColorEXT fnBlendColorEXT;
