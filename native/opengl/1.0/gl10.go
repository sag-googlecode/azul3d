...
func New() *Context {
	...
	glc.Bitmap = func(width, height int32, xorig, yorig, xmove, ymove float32, bitmap []uint8) {
		C.gl10Bitmap(glc.context, C.GLsizei(width), C.GLsizei(height), C.GLfloat(xorig), C.GLfloat(yorig), C.GLfloat(xmove), C.GLfloat(ymove), (*C.GLubyte)(unsafe.Pointer(&bitmap[0])))
	}
	...
	glc.ClipPlane = func(plane uint32, equation []float64) {
		C.gl10ClipPlane(glc.context, C.GLenum(plane), (*C.GLdouble)(unsafe.Pointer(&equation[0])))
	}
	...
	glc.Color3bv = func(v []int8) {
		C.gl10Color3bv(glc.context, (*C.GLbyte)(unsafe.Pointer(&v[0])))
	}

	glc.Color3dv = func(v []float64) {
		C.gl10Color3dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.Color3fv = func(v []float32) {
		C.gl10Color3fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.Color3iv = func(v []int32) {
		C.gl10Color3iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.Color3sv = func(v []int16) {
		C.gl10Color3sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.Color3ubv = func(v []uint8) {
		C.gl10Color3ubv(glc.context, (*C.GLubyte)(unsafe.Pointer(&v[0])))
	}

	glc.Color3uiv = func(v []uint32) {
		C.gl10Color3uiv(glc.context, (*C.GLuint)(unsafe.Pointer(&v[0])))
	}

	glc.Color3usv = func(v []uint16) {
		C.gl10Color3usv(glc.context, (*C.GLushort)(unsafe.Pointer(&v[0])))
	}

	glc.Color4bv = func(v []int8) {
		C.gl10Color4bv(glc.context, (*C.GLbyte)(unsafe.Pointer(&v[0])))
	}

	glc.Color4dv = func(v []float64) {
		C.gl10Color4dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.Color4fv = func(v []float32) {
		C.gl10Color4fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.Color4iv = func(v []int32) {
		C.gl10Color4iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.Color4sv = func(v []int16) {
		C.gl10Color4sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.Color4ubv = func(v []uint8) {
		C.gl10Color4ubv(glc.context, (*C.GLubyte)(unsafe.Pointer(&v[0])))
	}

	glc.Color4uiv = func(v []uint32) {
		C.gl10Color4uiv(glc.context, (*C.GLuint)(unsafe.Pointer(&v[0])))
	}

	glc.Color4usv = func(v []uint16) {
		C.gl10Color4usv(glc.context, (*C.GLushort)(unsafe.Pointer(&v[0])))
	}
	...
	glc.ColorTableParameterfv = func(target, pname uint32, params []float32) {
		C.gl10ColorTableParameterfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.ColorTableParameteriv = func(target, pname uint32, params []int32) {
		C.gl10ColorTableParameteriv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.DrawPixels = func(width, height int32, format, Type uint32, pixels unsafe.Pointer) {
		C.gl10DrawPixels(glc.context, C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLenum(Type), pixels)
	}
	...
	glc.EdgeFlagv = func(flag []bool) {
		C.gl10EdgeFlagv(glc.context, (*C.GLboolean)(unsafe.Pointer(&flag[0])))
	}
	...
	glc.EvalCoord1dv = func(u []float64) {
		C.gl10EvalCoord1dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&u[0])))
	}

	glc.EvalCoord1fv = func(u []float32) {
		C.gl10EvalCoord1fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&u[0])))
	}

	glc.EvalCoord2dv = func(u []float64) {
		C.gl10EvalCoord2dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&u[0])))
	}

	glc.EvalCoord2fv = func(u []float32) {
		C.gl10EvalCoord2fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&u[0])))
	}
	...
	glc.FeedbackBuffer = func(size int32, Type uint32, buffer []float32) {
		C.gl10FeedbackBuffer(glc.context, C.GLsizei(size), C.GLenum(Type), (*C.GLfloat)(unsafe.Pointer(&buffer[0])))
	}
	...
	glc.Fogfv = func(pname uint32, params []float32) {
		C.gl10Fogfv(glc.context, C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.Fogiv = func(pname uint32, params []int32) {
		C.gl10Fogiv(glc.context, C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.GetBooleanv = func(pname uint32, params []bool) {
		C.gl10GetBooleanv(glc.context, C.GLenum(pname), (*C.GLboolean)(unsafe.Pointer(&params[0])))
	}

	glc.GetDoublev = func(pname uint32, params []float64) {
		C.gl10GetDoublev(glc.context, C.GLenum(pname), (*C.GLdouble)(unsafe.Pointer(&params[0])))
	}

	glc.GetFloatv = func(pname uint32, params []float32) {
		C.gl10GetFloatv(glc.context, C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetIntegerv = func(pname uint32, params []int32) {
		C.gl10GetIntegerv(glc.context, C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}

	glc.GetClipPlane = func(plane uint32, equation []float64) {
		C.gl10GetClipPlane(glc.context, C.GLenum(plane), (*C.GLdouble)(unsafe.Pointer(&equation[0])))
	}
	...
	glc.GetLightfv = func(light, pname uint32, params []float32) {
		C.gl10GetLightfv(glc.context, C.GLenum(light), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetLightiv = func(light, pname uint32, params []int32) {
		C.gl10GetLightiv(glc.context, C.GLenum(light), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}

	glc.GetMapdv = func(target, query uint32, v []float64) {
		C.gl10GetMapdv(glc.context, C.GLenum(target), C.GLenum(query), (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.GetMapfv = func(target, query uint32, v []float32) {
		C.gl10GetMapfv(glc.context, C.GLenum(target), C.GLenum(query), (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.GetMapiv = func(target, query uint32, v []int32) {
		C.gl10GetMapiv(glc.context, C.GLenum(target), C.GLenum(query), (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.GetMaterialfv = func(face, pname uint32, params []float32) {
		C.gl10GetMaterialfv(glc.context, C.GLenum(face), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetMaterialiv = func(face, pname uint32, params []int32) {
		C.gl10GetMaterialiv(glc.context, C.GLenum(face), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}

	glc.GetPixelMapfv = func(Map uint32, values []float32) {
		C.gl10GetPixelMapfv(glc.context, C.GLenum(Map), (*C.GLfloat)(unsafe.Pointer(&values[0])))
	}

	glc.GetPixelMapuiv = func(Map uint32, values []uint32) {
		C.gl10GetPixelMapuiv(glc.context, C.GLenum(Map), (*C.GLuint)(unsafe.Pointer(&values[0])))
	}

	glc.GetPixelMapusv = func(Map uint32, values []uint16) {
		C.gl10GetPixelMapusv(glc.context, C.GLenum(Map), (*C.GLushort)(unsafe.Pointer(&values[0])))
	}

	glc.GetPolygonStipple = func(mask []uint8) {
		C.gl10GetPolygonStipple(glc.context, (*C.GLubyte)(unsafe.Pointer(&mask[0])))
	}
	...
	glc.GetTexEnvfv = func(target, pname uint32, params []float32) {
		C.gl10GetTexEnvfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexEnviv = func(target, pname uint32, params []int32) {
		C.gl10GetTexEnviv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexGendv = func(coord, pname uint32, params []float64) {
		C.gl10GetTexGendv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLdouble)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexGenfv = func(coord, pname uint32, params []float32) {
		C.gl10GetTexGenfv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexGeniv = func(coord, pname uint32, params []int32) {
		C.gl10GetTexGeniv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.GetTexLevelParameterfv = func(target uint32, level int32, pname uint32, params []float32) {
		C.gl10GetTexLevelParameterfv(glc.context, C.GLenum(target), C.GLint(level), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexLevelParameteriv = func(target uint32, level int32, pname uint32, params []int32) {
		C.gl10GetTexLevelParameteriv(glc.context, C.GLenum(target), C.GLint(level), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexParameterfv = func(target, pname uint32, params []float32) {
		C.gl10GetTexParameterfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexParameteriv = func(target, pname uint32, params []int32) {
		C.gl10GetTexParameteriv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.Indexdv = func(c []float64) {
		C.gl10Indexdv(glc.context, (*C.GLdouble)(unsafe.Pointer(&c[0])))
	}

	glc.Indexfv = func(c []float32) {
		C.gl10Indexfv(glc.context, (*C.GLfloat)(unsafe.Pointer(&c[0])))
	}

	glc.Indexiv = func(c []int32) {
		C.gl10Indexiv(glc.context, (*C.GLint)(unsafe.Pointer(&c[0])))
	}

	glc.Indexsv = func(c []int16) {
		C.gl10Indexsv(glc.context, (*C.GLshort)(unsafe.Pointer(&c[0])))
	}

	glc.Indexubv = func(c []uint8) {
		C.gl10Indexubv(glc.context, (*C.GLubyte)(unsafe.Pointer(&c[0])))
	}
	...
	glc.Lightfv = func(light, pname uint32, params []float32) {
		C.gl10Lightfv(glc.context, C.GLenum(light), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.Lightiv = func(light, pname uint32, params []int32) {
		C.gl10Lightiv(glc.context, C.GLenum(light), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.LightModelfv = func(pname uint32, params []float32) {
		C.gl10LightModelfv(glc.context, C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.LightModeliv = func(pname uint32, params []int32) {
		C.gl10LightModeliv(glc.context, C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.LoadMatrixd = func(m []float64) {
		C.gl10LoadMatrixd(glc.context, (*C.GLdouble)(unsafe.Pointer(&m[0])))
	}

	glc.LoadMatrixf = func(m []float32) {
		C.gl10LoadMatrixf(glc.context, (*C.GLfloat)(unsafe.Pointer(&m[0])))
	}
	...
	glc.Map1d = func(target uint32, u1, u2 float64, stride, order int32, points []float64) {
		C.gl10Map1d(glc.context, C.GLenum(target), C.GLdouble(u1), C.GLdouble(u2), C.GLint(stride), C.GLint(order), (*C.GLdouble)(unsafe.Pointer(&points[0])))
	}

	glc.Map1f = func(target uint32, u1, u2 float32, stride, order int32, points []float32) {
		C.gl10Map1f(glc.context, C.GLenum(target), C.GLfloat(u1), C.GLfloat(u2), C.GLint(stride), C.GLint(order), (*C.GLfloat)(unsafe.Pointer(&points[0])))
	}

	glc.Map2d = func(target uint32, u1, u2 float64, ustride, uorder int32, v1, v2 float64, vstride, vorder int32, points []float64) {
		C.gl10Map2d(glc.context, C.GLenum(target), C.GLdouble(u1), C.GLdouble(u2), C.GLint(ustride), C.GLint(uorder), C.GLdouble(v1), C.GLdouble(v2), C.GLint(vstride), C.GLint(vorder), (*C.GLdouble)(unsafe.Pointer(&points[0])))
	}

	glc.Map2f = func(target uint32, u1, u2 float32, ustride, uorder int32, v1, v2 float32, vstride, vorder int32, points []float32) {
		C.gl10Map2f(glc.context, C.GLenum(target), C.GLfloat(u1), C.GLfloat(u2), C.GLint(ustride), C.GLint(uorder), C.GLfloat(v1), C.GLfloat(v2), C.GLint(vstride), C.GLint(vorder), (*C.GLfloat)(unsafe.Pointer(&points[0])))
	}
	...
	glc.Materialfv = func(face, pname uint32, params []float32) {
		C.gl10Materialfv(glc.context, C.GLenum(face), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.Materialiv = func(face, pname uint32, params []int32) {
		C.gl10Materialiv(glc.context, C.GLenum(face), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.MultMatrixd = func(m []float64) {
		C.gl10MultMatrixd(glc.context, (*C.GLdouble)(unsafe.Pointer(&m[0])))
	}

	glc.MultMatrixf = func(m []float32) {
		C.gl10MultMatrixf(glc.context, (*C.GLfloat)(unsafe.Pointer(&m[0])))
	}
	...
	glc.Normal3bv = func(v []int8) {
		C.gl10Normal3bv(glc.context, (*C.GLbyte)(unsafe.Pointer(&v[0])))
	}

	glc.Normal3dv = func(v []float64) {
		C.gl10Normal3dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.Normal3fv = func(v []float32) {
		C.gl10Normal3fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.Normal3iv = func(v []int32) {
		C.gl10Normal3iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.Normal3sv = func(v []int16) {
		C.gl10Normal3sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}
	...
	glc.PixelMapfv = func(Map uint32, mapsize int32, values []float32) {
		C.gl10PixelMapfv(glc.context, C.GLenum(Map), C.GLsizei(mapsize), (*C.GLfloat)(unsafe.Pointer(&values[0])))
	}

	glc.PixelMapuiv = func(Map uint32, mapsize int32, values []uint32) {
		C.gl10PixelMapuiv(glc.context, C.GLenum(Map), C.GLsizei(mapsize), (*C.GLuint)(unsafe.Pointer(&values[0])))
	}

	glc.PixelMapusv = func(Map uint32, mapsize int32, values []uint16) {
		C.gl10PixelMapusv(glc.context, C.GLenum(Map), C.GLsizei(mapsize), (*C.GLushort)(unsafe.Pointer(&values[0])))
	}
	...
	glc.PolygonStipple = func(mask []uint8) {
		C.gl10PolygonStipple(glc.context, (*C.GLubyte)(unsafe.Pointer(&mask[0])))
	}

	glc.PrioritizeTextures = func(n int32, textures []uint32, priorities []float32) {
		C.gl10PrioritizeTextures(glc.context, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(&textures[0])), (*C.GLclampf)(unsafe.Pointer(&priorities[0])))
	}
	...
	glc.RasterPos2dv = func(v []float64) {
		C.gl10RasterPos2dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos2fv = func(v []float32) {
		C.gl10RasterPos2fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos2iv = func(v []int32) {
		C.gl10RasterPos2iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos2sv = func(v []int16) {
		C.gl10RasterPos2sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos3dv = func(v []float64) {
		C.gl10RasterPos3dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos3fv = func(v []float32) {
		C.gl10RasterPos3fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos3iv = func(v []int32) {
		C.gl10RasterPos3iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos3sv = func(v []int16) {
		C.gl10RasterPos3sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos4dv = func(v []float64) {
		C.gl10RasterPos4dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos4fv = func(v []float32) {
		C.gl10RasterPos4fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos4iv = func(v []int32) {
		C.gl10RasterPos4iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos4sv = func(v []int16) {
		C.gl10RasterPos4sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}
	...
	glc.Rectdv = func(v1, v2 []float64) {
		C.gl10Rectdv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v1[0])), (*C.GLdouble)(unsafe.Pointer(&v2[0])))
	}

	glc.Rectfv = func(v1, v2 []float32) {
		C.gl10Rectfv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v1[0])), (*C.GLfloat)(unsafe.Pointer(&v2[0])))
	}

	glc.Rectiv = func(v1, v2 []int32) {
		C.gl10Rectiv(glc.context, (*C.GLint)(unsafe.Pointer(&v1[0])), (*C.GLint)(unsafe.Pointer(&v2[0])))
	}

	glc.Rectsv = func(v1, v2 []int16) {
		C.gl10Rectsv(glc.context, (*C.GLshort)(unsafe.Pointer(&v1[0])), (*C.GLshort)(unsafe.Pointer(&v2[0])))
	}
	...
	glc.SelectBuffer = func(size int32, buffer []uint32) {
		C.gl10SelectBuffer(glc.context, C.GLsizei(size), (*C.GLuint)(unsafe.Pointer(&buffer[0])))
	}
	...
	glc.TexCoord1dv = func(v []float64) {
		C.gl10TexCoord1dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord1fv = func(v []float32) {
		C.gl10TexCoord1fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord1iv = func(v []int32) {
		C.gl10TexCoord1iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord1sv = func(v []int16) {
		C.gl10TexCoord1sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord2dv = func(v []float64) {
		C.gl10TexCoord2dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord2fv = func(v []float32) {
		C.gl10TexCoord2fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord2iv = func(v []int32) {
		C.gl10TexCoord2iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord2sv = func(v []int16) {
		C.gl10TexCoord2sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord3dv = func(v []float64) {
		C.gl10TexCoord3dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord3fv = func(v []float32) {
		C.gl10TexCoord3fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord3iv = func(v []int32) {
		C.gl10TexCoord3iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord3sv = func(v []int16) {
		C.gl10TexCoord3sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord4dv = func(v []float64) {
		C.gl10TexCoord4dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord4fv = func(v []float32) {
		C.gl10TexCoord4fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord4iv = func(v []int32) {
		C.gl10TexCoord4iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord4sv = func(v []int16) {
		C.gl10TexCoord4sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}
	...
	glc.TexEnvfv = func(target, pname uint32, params []float32) {
		C.gl10TexEnvfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.TexEnviv = func(target, pname uint32, params []int32) {
		C.gl10TexEnviv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.TexGendv = func(coord, pname uint32, params []float64) {
		C.gl10TexGendv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLdouble)(unsafe.Pointer(&params[0])))
	}

	glc.TexGenfv = func(coord, pname uint32, params []float32) {
		C.gl10TexGenfv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.TexGeniv = func(coord, pname uint32, params []int32) {
		C.gl10TexGeniv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.TexImage3DEXT = func(target uint32, level, internalformat int32, width, height, depth int32, border int32, format, Type uint32, pixels unsafe.Pointer) {
		C.gl10TexImage3DEXT(glc.context, C.GLenum(target), C.GLint(level), C.GLint(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLint(border), C.GLenum(format), C.GLenum(Type), pixels)
	}
	...
	glc.TexParameterfv = func(target, pname uint32, params []float32) {
		C.gl10TexParameterfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.TexParameteriv = func(target, pname uint32, params []int32) {
		C.gl10TexParameteriv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.TexSubImage3DEXT = func(target uint32, level, xoffset, yoffset, zoffset int32, width, height, depth int32, format, Type uint32, pixels unsafe.Pointer) {
		C.gl10TexSubImage3DEXT(glc.context, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLint(yoffset), C.GLint(zoffset), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLenum(format), C.GLenum(Type), pixels)
	}
