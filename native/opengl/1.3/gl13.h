...
typedef void(*gl13PTexImage3DEXT)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, GLvoid*);
...
typedef void(*gl13PTexSubImage3DEXT)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, GLvoid*);
...
typedef void(*gl13PBlendColorEXT)(GLclampf, GLclampf, GLclampf, GLclampf);
...
typedef struct {
    ...
    gl13PTexImage3DEXT fnTexImage3DEXT;
    ...
    gl13PTexSubImage3DEXT fnTexSubImage3DEXT;
    ...
    gl13PBlendColorEXT fnBlendColorEXT;
