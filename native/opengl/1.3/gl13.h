...
typedef void(*gl13PBlendFuncSeparate)(GLenum, GLenum, GLenum, GLenum);
typedef void(*gl13PFogCoordPointer)(GLenum, GLsizei, GLvoid*);
typedef void(*gl13PFogCoordd)(GLdouble);
typedef void(*gl13PFogCoordf)(GLfloat);
typedef void(*gl13PFogCoorddv)(GLdouble*);
typedef void(*gl13PFogCoordfv)(GLfloat*);
typedef void(*gl13PMultiDrawArrays)(GLenum, GLint*, GLsizei*, GLsizei);
typedef void(*gl13PMultiDrawElements)(GLenum, GLsizei*, GLenum, GLvoid*, GLsizei);
typedef void(*gl13PPointParameterf)(GLenum, GLfloat);
typedef void(*gl13PPointParameteri)(GLenum, GLint);
typedef void(*gl13PSecondaryColor3b)(GLbyte, GLbyte, GLbyte);
typedef void(*gl13PSecondaryColor3s)(GLshort, GLshort, GLshort);
typedef void(*gl13PSecondaryColor3i)(GLint, GLint, GLint);
typedef void(*gl13PSecondaryColor3f)(GLfloat, GLfloat, GLfloat);
typedef void(*gl13PSecondaryColor3d)(GLdouble, GLdouble, GLdouble);
typedef void(*gl13PSecondaryColor3ub)(GLubyte, GLubyte, GLubyte);
typedef void(*gl13PSecondaryColor3us)(GLushort, GLushort, GLushort);
typedef void(*gl13PSecondaryColor3ui)(GLuint, GLuint, GLuint);
typedef void(*gl13PSecondaryColor3bv)(GLbyte*);
typedef void(*gl13PSecondaryColor3sv)(GLshort*);
typedef void(*gl13PSecondaryColor3iv)(GLint*);
typedef void(*gl13PSecondaryColor3fv)(GLfloat*);
typedef void(*gl13PSecondaryColor3dv)(GLdouble*);
typedef void(*gl13PSecondaryColor3ubv)(GLubyte*);
typedef void(*gl13PSecondaryColor3usv)(GLushort*);
typedef void(*gl13PSecondaryColor3uiv)(GLuint*);
typedef void(*gl13PSecondaryColorPointer)(GLint, GLenum, GLsizei, GLvoid*);
typedef void(*gl13PWindowPos2s)(GLshort, GLshort);
typedef void(*gl13PWindowPos2i)(GLint, GLint);
typedef void(*gl13PWindowPos2f)(GLfloat, GLfloat);
typedef void(*gl13PWindowPos2d)(GLdouble, GLdouble);
typedef void(*gl13PWindowPos3s)(GLshort, GLshort, GLshort);
typedef void(*gl13PWindowPos3i)(GLint, GLint, GLint);
typedef void(*gl13PWindowPos3f)(GLfloat, GLfloat, GLfloat);
typedef void(*gl13PWindowPos3d)(GLdouble, GLdouble, GLdouble);
typedef void(*gl13PWindowPos2sv)(GLshort*);
typedef void(*gl13PWindowPos2iv)(GLint*);
typedef void(*gl13PWindowPos2fv)(GLfloat*);
typedef void(*gl13PWindowPos2dv)(GLdouble*);
typedef void(*gl13PWindowPos3sv)(GLshort*);
typedef void(*gl13PWindowPos3iv)(GLint*);
typedef void(*gl13PWindowPos3fv)(GLfloat*);
typedef void(*gl13PWindowPos3dv)(GLdouble*);
typedef void(*gl13PBeginQuery)(GLenum, GLuint);
typedef void(*gl13PBindBuffer)(GLenum, GLuint);
typedef void(*gl13PBufferData)(GLenum, GLsizeiptr, GLvoid*, GLenum);
typedef void(*gl13PBufferSubData)(GLenum, GLenum, GLsizeiptr, GLvoid*);
typedef void(*gl13PDeleteBuffers)(GLsizei, GLuint*);
typedef void(*gl13PDeleteQueries)(GLsizei, GLuint*);
typedef void(*gl13PGenBuffers)(GLsizei, GLuint*);
typedef void(*gl13PGenQueries)(GLsizei, GLuint*);
typedef void(*gl13PGetBufferParameteriv)(GLenum, GLenum, GLint*);
typedef void(*gl13PGetBufferPointerv)(GLenum, GLenum, GLvoid*);
typedef void(*gl13PGetBufferSubData)(GLenum, GLintptr, GLsizeiptr, GLvoid*);
typedef void(*gl13PGetQueryObjectiv)(GLuint, GLenum, GLint*);
typedef void(*gl13PGetQueryObjectuiv)(GLuint, GLenum, GLuint*);
typedef void(*gl13PGetQueryiv)(GLenum, GLenum, GLint*);
typedef GLboolean(*gl13PIsBuffer)(GLuint);
typedef GLboolean(*gl13PIsQuery)(GLuint);
typedef GLvoid*(*gl13PMapBuffer)(GLenum, GLenum);
typedef GLboolean(*gl13PUnmapBuffer)(GLenum);
typedef void(*gl13PAttachShader)(GLuint, GLuint);
typedef void(*gl13PBindAttribLocation)(GLuint, GLuint, GLchar*);
typedef void(*gl13PBlendEquationSeperate)(GLenum, GLenum);
typedef void(*gl13PCompileShader)(GLuint);
typedef GLuint(*gl13PCreateProgram)();
typedef GLuint(*gl13PCreateShader)(GLenum);
typedef void(*gl13PDeleteProgram)(GLuint);
typedef void(*gl13PDeleteShader)(GLuint);
typedef void(*gl13PDetachShader)(GLuint, GLuint);
typedef void(*gl13PEnableVertexAttribArray)(GLuint);
typedef void(*gl13PDisableVertexAttribArray)(GLuint);
typedef void(*gl13PDrawBuffers)(GLsizei, GLenum*);
typedef void(*gl13PGetActiveAttrib)(GLuint, GLuint, GLsizei, GLsizei*, GLint*, GLenum*, GLchar*);
typedef void(*gl13PGetActiveUniform)(GLuint, GLuint, GLsizei, GLsizei*, GLint*, GLenum*, GLchar*);
typedef void(*gl13PGetAttachedShaders)(GLuint, GLsizei, GLsizei*, GLuint*);
typedef GLint(*gl13PGetAttribLocation)(GLuint, GLchar*);
typedef void(*gl13PGetProgramiv)(GLuint, GLenum, GLint*);
typedef void(*gl13PGetProgramInfoLog)(GLuint, GLsizei, GLsizei*, GLchar*);
typedef void(*gl13PGetShaderiv)(GLuint, GLenum, GLint*);
typedef void(*gl13PGetShaderInfoLog)(GLuint, GLsizei, GLsizei*, GLchar*);
typedef void(*gl13PGetShaderSource)(GLuint, GLsizei, GLsizei*, GLchar*);
typedef void(*gl13PGetUniformfv)(GLuint, GLint, GLfloat*);
typedef void(*gl13PGetUniformiv)(GLuint, GLint, GLint*);
typedef GLint(*gl13PGetUniformLocation)(GLuint, GLchar*);
typedef void(*gl13PGetVertexAttribdv)(GLuint, GLenum, GLdouble*);
typedef void(*gl13PGetVertexAttribfv)(GLuint, GLenum, GLfloat*);
typedef void(*gl13PGetVertexAttribiv)(GLuint, GLenum, GLint*);
typedef void(*gl13PGetVertexAttribPointerv)(GLuint, GLenum, GLvoid*);
typedef GLboolean(*gl13PIsProgram)(GLuint);
typedef GLboolean(*gl13PIsShader)(GLuint);
typedef void(*gl13PLinkProgram)(GLuint);
typedef void(*gl13PShaderSource)(GLuint, GLsizei, GLchar**, GLint*);
typedef void(*gl13PStencilFuncSeparate)(GLenum, GLenum, GLint, GLuint);
typedef void(*gl13PStencilMaskSeparate)(GLenum, GLuint);
typedef void(*gl13PStencilOpSeparate)(GLenum, GLenum, GLenum, GLenum);
typedef void(*gl13PUniform1f)(GLint, GLfloat);
typedef void(*gl13PUniform2f)(GLint, GLfloat, GLfloat);
typedef void(*gl13PUniform3f)(GLint, GLfloat, GLfloat, GLfloat);
typedef void(*gl13PUniform4f)(GLint, GLfloat, GLfloat, GLfloat, GLfloat);
typedef void(*gl13PUniform1i)(GLint, GLint);
typedef void(*gl13PUniform2i)(GLint, GLint, GLint);
typedef void(*gl13PUniform3i)(GLint, GLint, GLint, GLint);
typedef void(*gl13PUniform4i)(GLint, GLint, GLint, GLint, GLint);
typedef void(*gl13PUniform1ui)(GLint, GLuint);
typedef void(*gl13PUniform2ui)(GLint, GLuint, GLuint);
typedef void(*gl13PUniform3ui)(GLint, GLuint, GLuint, GLuint);
typedef void(*gl13PUniform4ui)(GLint, GLuint, GLuint, GLuint, GLuint);
typedef void(*gl13PUniform1fv)(GLint, GLsizei, GLfloat*);
typedef void(*gl13PUniform2fv)(GLint, GLsizei, GLfloat*);
typedef void(*gl13PUniform3fv)(GLint, GLsizei, GLfloat*);
typedef void(*gl13PUniform4fv)(GLint, GLsizei, GLfloat*);
typedef void(*gl13PUniform1iv)(GLint, GLsizei, GLint*);
typedef void(*gl13PUniform2iv)(GLint, GLsizei, GLint*);
typedef void(*gl13PUniform3iv)(GLint, GLsizei, GLint*);
typedef void(*gl13PUniform4iv)(GLint, GLsizei, GLint*);
typedef void(*gl13PUniform1uiv)(GLint, GLsizei, GLuint*);
typedef void(*gl13PUniform2uiv)(GLint, GLsizei, GLuint*);
typedef void(*gl13PUniform3uiv)(GLint, GLsizei, GLuint*);
typedef void(*gl13PUniform4uiv)(GLint, GLsizei, GLuint*);
typedef void(*gl13PUseProgram)(GLuint);
typedef void(*gl13PValidateProgram)(GLuint);
typedef void(*gl13PVertexAttribPointer)(GLuint, GLint, GLenum, GLboolean, GLsizei, GLvoid*);
typedef void(*gl13PVertexAttrib1f)(GLuint, GLfloat);
typedef void(*gl13PVertexAttrib1s)(GLuint, GLshort);
typedef void(*gl13PVertexAttrib1d)(GLuint, GLdouble);
typedef void(*gl13PVertexAttrib2f)(GLuint, GLfloat, GLfloat);
typedef void(*gl13PVertexAttrib2s)(GLuint, GLshort, GLshort);
typedef void(*gl13PVertexAttrib2d)(GLuint, GLdouble, GLdouble);
typedef void(*gl13PVertexAttrib3f)(GLuint, GLfloat, GLfloat, GLfloat);
typedef void(*gl13PVertexAttrib3s)(GLuint, GLshort, GLshort, GLshort);
typedef void(*gl13PVertexAttrib3d)(GLuint, GLdouble, GLdouble, GLdouble);
typedef void(*gl13PVertexAttrib4f)(GLuint, GLfloat, GLfloat, GLfloat, GLfloat);
typedef void(*gl13PVertexAttrib4s)(GLuint, GLshort, GLshort, GLshort, GLshort);
typedef void(*gl13PVertexAttrib4d)(GLuint, GLdouble, GLdouble, GLdouble, GLdouble);
typedef void(*gl13PVertexAttrib4Nuv)(GLuint, GLubyte, GLubyte, GLubyte, GLubyte);
typedef void(*gl13PVertexAttrib1fv)(GLuint, GLfloat*);
typedef void(*gl13PVertexAttrib1sv)(GLuint, GLshort*);
typedef void(*gl13PVertexAttrib1dv)(GLuint, GLdouble*);
typedef void(*gl13PVertexAttrib2fv)(GLuint, GLfloat*);
typedef void(*gl13PVertexAttrib2sv)(GLuint, GLshort*);
typedef void(*gl13PVertexAttrib2dv)(GLuint, GLdouble*);
typedef void(*gl13PVertexAttrib3fv)(GLuint, GLfloat*);
typedef void(*gl13PVertexAttrib3sv)(GLuint, GLshort*);
typedef void(*gl13PVertexAttrib3dv)(GLuint, GLdouble*);
typedef void(*gl13PVertexAttrib4fv)(GLuint, GLfloat*);
typedef void(*gl13PVertexAttrib4sv)(GLuint, GLshort*);
typedef void(*gl13PVertexAttrib4dv)(GLuint, GLdouble*);
typedef void(*gl13PVertexAttrib4iv)(GLuint, GLint*);
typedef void(*gl13PVertexAttrib4bv)(GLuint, GLbyte*);
typedef void(*gl13PVertexAttrib4ubv)(GLuint, GLubyte*);
typedef void(*gl13PVertexAttrib4usv)(GLuint, GLushort*);
typedef void(*gl13PVertexAttrib4uiv)(GLuint, GLuint*);
typedef void(*gl13PVertexAttrib4Nbv)(GLuint, GLbyte*);
typedef void(*gl13PVertexAttrib4Nsv)(GLuint, GLshort*);
typedef void(*gl13PVertexAttrib4Niv)(GLuint, GLint*);
typedef void(*gl13PVertexAttrib4Nubv)(GLuint, GLubyte*);
typedef void(*gl13PVertexAttrib4Nusv)(GLuint, GLushort*);
typedef void(*gl13PVertexAttrib4Nuiv)(GLuint, GLuint*);
typedef void(*gl13PUniformMatrix2fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl13PUniformMatrix3fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl13PUniformMatrix4fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl13PUniformMatrix2x3fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl13PUniformMatrix3x2fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl13PUniformMatrix2x4fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl13PUniformMatrix4x2fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl13PUniformMatrix3x4fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl13PUniformMatrix4x3fv)(GLint, GLsizei, GLboolean, GLfloat*);
...
typedef struct {
    ...
    gl13PBlendFuncSeparate fnBlendFuncSeparate;
    gl13PFogCoordPointer fnFogCoordPointer;
    gl13PFogCoordd fnFogCoordd;
    gl13PFogCoordf fnFogCoordf;
    gl13PFogCoorddv fnFogCoorddv;
    gl13PFogCoordfv fnFogCoordfv;
    gl13PMultiDrawArrays fnMultiDrawArrays;
    gl13PMultiDrawElements fnMultiDrawElements;
    gl13PPointParameterf fnPointParameterf;
    gl13PPointParameteri fnPointParameteri;
    gl13PSecondaryColor3b fnSecondaryColor3b;
    gl13PSecondaryColor3s fnSecondaryColor3s;
    gl13PSecondaryColor3i fnSecondaryColor3i;
    gl13PSecondaryColor3f fnSecondaryColor3f;
    gl13PSecondaryColor3d fnSecondaryColor3d;
    gl13PSecondaryColor3ub fnSecondaryColor3ub;
    gl13PSecondaryColor3us fnSecondaryColor3us;
    gl13PSecondaryColor3ui fnSecondaryColor3ui;
    gl13PSecondaryColor3bv fnSecondaryColor3bv;
    gl13PSecondaryColor3sv fnSecondaryColor3sv;
    gl13PSecondaryColor3iv fnSecondaryColor3iv;
    gl13PSecondaryColor3fv fnSecondaryColor3fv;
    gl13PSecondaryColor3dv fnSecondaryColor3dv;
    gl13PSecondaryColor3ubv fnSecondaryColor3ubv;
    gl13PSecondaryColor3usv fnSecondaryColor3usv;
    gl13PSecondaryColor3uiv fnSecondaryColor3uiv;
    gl13PSecondaryColorPointer fnSecondaryColorPointer;
    gl13PWindowPos2s fnWindowPos2s;
    gl13PWindowPos2i fnWindowPos2i;
    gl13PWindowPos2f fnWindowPos2f;
    gl13PWindowPos2d fnWindowPos2d;
    gl13PWindowPos3s fnWindowPos3s;
    gl13PWindowPos3i fnWindowPos3i;
    gl13PWindowPos3f fnWindowPos3f;
    gl13PWindowPos3d fnWindowPos3d;
    gl13PWindowPos2sv fnWindowPos2sv;
    gl13PWindowPos2iv fnWindowPos2iv;
    gl13PWindowPos2fv fnWindowPos2fv;
    gl13PWindowPos2dv fnWindowPos2dv;
    gl13PWindowPos3sv fnWindowPos3sv;
    gl13PWindowPos3iv fnWindowPos3iv;
    gl13PWindowPos3fv fnWindowPos3fv;
    gl13PWindowPos3dv fnWindowPos3dv;
    gl13PBeginQuery fnBeginQuery;
    gl13PBindBuffer fnBindBuffer;
    gl13PBufferData fnBufferData;
    gl13PBufferSubData fnBufferSubData;
    gl13PDeleteBuffers fnDeleteBuffers;
    gl13PDeleteQueries fnDeleteQueries;
    gl13PGenBuffers fnGenBuffers;
    gl13PGenQueries fnGenQueries;
    gl13PGetBufferParameteriv fnGetBufferParameteriv;
    gl13PGetBufferPointerv fnGetBufferPointerv;
    gl13PGetBufferSubData fnGetBufferSubData;
    gl13PGetQueryObjectiv fnGetQueryObjectiv;
    gl13PGetQueryObjectuiv fnGetQueryObjectuiv;
    gl13PGetQueryiv fnGetQueryiv;
    gl13PIsBuffer fnIsBuffer;
    gl13PIsQuery fnIsQuery;
    gl13PMapBuffer fnMapBuffer;
    gl13PUnmapBuffer fnUnmapBuffer;
    gl13PAttachShader fnAttachShader;
    gl13PBindAttribLocation fnBindAttribLocation;
    gl13PBlendEquationSeperate fnBlendEquationSeperate;
    gl13PCompileShader fnCompileShader;
    gl13PCreateProgram fnCreateProgram;
    gl13PCreateShader fnCreateShader;
    gl13PDeleteProgram fnDeleteProgram;
    gl13PDeleteShader fnDeleteShader;
    gl13PDetachShader fnDetachShader;
    gl13PEnableVertexAttribArray fnEnableVertexAttribArray;
    gl13PDisableVertexAttribArray fnDisableVertexAttribArray;
    gl13PDrawBuffers fnDrawBuffers;
    gl13PGetActiveAttrib fnGetActiveAttrib;
    gl13PGetActiveUniform fnGetActiveUniform;
    gl13PGetAttachedShaders fnGetAttachedShaders;
    gl13PGetAttribLocation fnGetAttribLocation;
    gl13PGetProgramiv fnGetProgramiv;
    gl13PGetProgramInfoLog fnGetProgramInfoLog;
    gl13PGetShaderiv fnGetShaderiv;
    gl13PGetShaderInfoLog fnGetShaderInfoLog;
    gl13PGetShaderSource fnGetShaderSource;
    gl13PGetUniformfv fnGetUniformfv;
    gl13PGetUniformiv fnGetUniformiv;
    gl13PGetUniformLocation fnGetUniformLocation;
    gl13PGetVertexAttribdv fnGetVertexAttribdv;
    gl13PGetVertexAttribfv fnGetVertexAttribfv;
    gl13PGetVertexAttribiv fnGetVertexAttribiv;
    gl13PGetVertexAttribPointerv fnGetVertexAttribPointerv;
    gl13PIsProgram fnIsProgram;
    gl13PIsShader fnIsShader;
    gl13PLinkProgram fnLinkProgram;
    gl13PShaderSource fnShaderSource;
    gl13PStencilFuncSeparate fnStencilFuncSeparate;
    gl13PStencilMaskSeparate fnStencilMaskSeparate;
    gl13PStencilOpSeparate fnStencilOpSeparate;
    gl13PUniform1f fnUniform1f;
    gl13PUniform2f fnUniform2f;
    gl13PUniform3f fnUniform3f;
    gl13PUniform4f fnUniform4f;
    gl13PUniform1i fnUniform1i;
    gl13PUniform2i fnUniform2i;
    gl13PUniform3i fnUniform3i;
    gl13PUniform4i fnUniform4i;
    gl13PUniform1ui fnUniform1ui;
    gl13PUniform2ui fnUniform2ui;
    gl13PUniform3ui fnUniform3ui;
    gl13PUniform4ui fnUniform4ui;
    gl13PUniform1fv fnUniform1fv;
    gl13PUniform2fv fnUniform2fv;
    gl13PUniform3fv fnUniform3fv;
    gl13PUniform4fv fnUniform4fv;
    gl13PUniform1iv fnUniform1iv;
    gl13PUniform2iv fnUniform2iv;
    gl13PUniform3iv fnUniform3iv;
    gl13PUniform4iv fnUniform4iv;
    gl13PUniform1uiv fnUniform1uiv;
    gl13PUniform2uiv fnUniform2uiv;
    gl13PUniform3uiv fnUniform3uiv;
    gl13PUniform4uiv fnUniform4uiv;
    gl13PUseProgram fnUseProgram;
    gl13PValidateProgram fnValidateProgram;
    gl13PVertexAttribPointer fnVertexAttribPointer;
    gl13PVertexAttrib1f fnVertexAttrib1f;
    gl13PVertexAttrib1s fnVertexAttrib1s;
    gl13PVertexAttrib1d fnVertexAttrib1d;
    gl13PVertexAttrib2f fnVertexAttrib2f;
    gl13PVertexAttrib2s fnVertexAttrib2s;
    gl13PVertexAttrib2d fnVertexAttrib2d;
    gl13PVertexAttrib3f fnVertexAttrib3f;
    gl13PVertexAttrib3s fnVertexAttrib3s;
    gl13PVertexAttrib3d fnVertexAttrib3d;
    gl13PVertexAttrib4f fnVertexAttrib4f;
    gl13PVertexAttrib4s fnVertexAttrib4s;
    gl13PVertexAttrib4d fnVertexAttrib4d;
    gl13PVertexAttrib4Nuv fnVertexAttrib4Nuv;
    gl13PVertexAttrib1fv fnVertexAttrib1fv;
    gl13PVertexAttrib1sv fnVertexAttrib1sv;
    gl13PVertexAttrib1dv fnVertexAttrib1dv;
    gl13PVertexAttrib2fv fnVertexAttrib2fv;
    gl13PVertexAttrib2sv fnVertexAttrib2sv;
    gl13PVertexAttrib2dv fnVertexAttrib2dv;
    gl13PVertexAttrib3fv fnVertexAttrib3fv;
    gl13PVertexAttrib3sv fnVertexAttrib3sv;
    gl13PVertexAttrib3dv fnVertexAttrib3dv;
    gl13PVertexAttrib4fv fnVertexAttrib4fv;
    gl13PVertexAttrib4sv fnVertexAttrib4sv;
    gl13PVertexAttrib4dv fnVertexAttrib4dv;
    gl13PVertexAttrib4iv fnVertexAttrib4iv;
    gl13PVertexAttrib4bv fnVertexAttrib4bv;
    gl13PVertexAttrib4ubv fnVertexAttrib4ubv;
    gl13PVertexAttrib4usv fnVertexAttrib4usv;
    gl13PVertexAttrib4uiv fnVertexAttrib4uiv;
    gl13PVertexAttrib4Nbv fnVertexAttrib4Nbv;
    gl13PVertexAttrib4Nsv fnVertexAttrib4Nsv;
    gl13PVertexAttrib4Niv fnVertexAttrib4Niv;
    gl13PVertexAttrib4Nubv fnVertexAttrib4Nubv;
    gl13PVertexAttrib4Nusv fnVertexAttrib4Nusv;
    gl13PVertexAttrib4Nuiv fnVertexAttrib4Nuiv;
    gl13PUniformMatrix2fv fnUniformMatrix2fv;
    gl13PUniformMatrix3fv fnUniformMatrix3fv;
    gl13PUniformMatrix4fv fnUniformMatrix4fv;
    gl13PUniformMatrix2x3fv fnUniformMatrix2x3fv;
    gl13PUniformMatrix3x2fv fnUniformMatrix3x2fv;
    gl13PUniformMatrix2x4fv fnUniformMatrix2x4fv;
    gl13PUniformMatrix4x2fv fnUniformMatrix4x2fv;
    gl13PUniformMatrix3x4fv fnUniformMatrix3x4fv;
    gl13PUniformMatrix4x3fv fnUniformMatrix4x3fv;
} gl13Context;
