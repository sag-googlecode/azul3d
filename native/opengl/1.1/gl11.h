...
typedef void(*gl11PTexImage3DEXT)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, GLvoid*);
...
typedef void(*gl11PTexSubImage3DEXT)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, GLvoid*);
...
typedef struct {
    ...
    gl11PTexImage3DEXT fnTexImage3DEXT;
    ...
    gl11PTexSubImage3DEXT fnTexSubImage3DEXT;
