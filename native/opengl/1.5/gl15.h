...
typedef void(*gl15PTexImage3DEXT)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, GLvoid*);
...
typedef void(*gl15PTexSubImage3DEXT)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, GLvoid*);
...
typedef void(*gl15PBlendColorEXT)(GLclampf, GLclampf, GLclampf, GLclampf);
...
typedef struct {
    ...
    gl15PTexImage3DEXT fnTexImage3DEXT;
    ...
    gl15PTexSubImage3DEXT fnTexSubImage3DEXT;
    ...
    gl15PBlendColorEXT fnBlendColorEXT;
