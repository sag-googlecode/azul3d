...
typedef void(*gl20PDepthMask)(GLboolean);
...
typedef void(*gl20PGetConvolutionParameterfv)(GLenum, GLenum, GLfloat*);
typedef void(*gl20PGetConvolutionParameteriv)(GLenum, GLenum, GLint*);
...
typedef void(*gl20PGetColorTable)(GLenum, GLenum, GLenum, GLvoid*);
typedef void(*gl20PGetColorTableParameterfv)(GLenum, GLenum, GLfloat*);
typedef void(*gl20PGetColorTableParameteriv)(GLenum, GLenum, GLint*);
typedef void(*gl20PGetConvolutionFilter)(GLenum, GLenum, GLenum, GLvoid*);
typedef void(*gl20PGetHistogram)(GLenum, GLboolean, GLenum, GLenum, GLvoid*);
typedef void(*gl20PGetHistogramParameterfv)(GLenum, GLenum, GLfloat*);
typedef void(*gl20PGetHistogramParameteriv)(GLenum, GLenum, GLint*);
typedef void(*gl20PGetSeparableFilter)(GLenum, GLenum, GLenum, GLvoid*, GLvoid*, GLvoid*);
typedef void(*gl20PHistogram)(GLenum, GLsizei, GLenum, GLboolean);
typedef void(*gl20PMinmax)(GLenum, GLenum, GLboolean);
typedef void(*gl20PMultiTexCoord1s)(GLenum, GLshort);
typedef void(*gl20PMultiTexCoord1i)(GLenum, GLint);
typedef void(*gl20PMultiTexCoord1f)(GLenum, GLfloat);
typedef void(*gl20PMultiTexCoord1d)(GLenum, GLdouble);
typedef void(*gl20PMultiTexCoord2s)(GLenum, GLshort, GLshort);
typedef void(*gl20PMultiTexCoord2i)(GLenum, GLint, GLint);
typedef void(*gl20PMultiTexCoord2f)(GLenum, GLfloat, GLfloat);
typedef void(*gl20PMultiTexCoord2d)(GLenum, GLdouble, GLdouble);
typedef void(*gl20PMultiTexCoord3s)(GLenum, GLshort, GLshort, GLshort);
typedef void(*gl20PMultiTexCoord3i)(GLenum, GLint, GLint, GLint);
typedef void(*gl20PMultiTexCoord3f)(GLenum, GLfloat, GLfloat, GLfloat);
typedef void(*gl20PMultiTexCoord3d)(GLenum, GLdouble, GLdouble, GLdouble);
typedef void(*gl20PMultiTexCoord4s)(GLenum, GLshort, GLshort, GLshort, GLshort);
typedef void(*gl20PMultiTexCoord4i)(GLenum, GLint, GLint, GLint, GLint);
typedef void(*gl20PMultiTexCoord4f)(GLenum, GLfloat, GLfloat, GLfloat, GLfloat);
typedef void(*gl20PMultiTexCoord4d)(GLenum, GLdouble, GLdouble, GLdouble, GLdouble);
typedef void(*gl20PMultiTexCoord1sv)(GLenum, GLshort*);
typedef void(*gl20PMultiTexCoord1iv)(GLenum, GLint*);
typedef void(*gl20PMultiTexCoord1fv)(GLenum, GLfloat*);
typedef void(*gl20PMultiTexCoord1dv)(GLenum, GLdouble*);
typedef void(*gl20PMultiTexCoord2sv)(GLenum, GLshort*);
typedef void(*gl20PMultiTexCoord2iv)(GLenum, GLint*);
typedef void(*gl20PMultiTexCoord2fv)(GLenum, GLfloat*);
typedef void(*gl20PMultiTexCoord2dv)(GLenum, GLdouble*);
typedef void(*gl20PMultiTexCoord3sv)(GLenum, GLshort*);
typedef void(*gl20PMultiTexCoord3iv)(GLenum, GLint*);
typedef void(*gl20PMultiTexCoord3fv)(GLenum, GLfloat*);
typedef void(*gl20PMultiTexCoord3dv)(GLenum, GLdouble*);
typedef void(*gl20PMultiTexCoord4sv)(GLenum, GLshort*);
typedef void(*gl20PMultiTexCoord4iv)(GLenum, GLint*);
typedef void(*gl20PMultiTexCoord4fv)(GLenum, GLfloat*);
typedef void(*gl20PMultiTexCoord4dv)(GLenum, GLdouble*);
typedef void(*gl20PResetHistogram)(GLenum);
typedef void(*gl20PResetMinmax)(GLenum);
typedef void(*gl20PSeparableFilter2D)(GLenum, GLenum, GLsizei, GLsizei, GLenum, GLenum, GLvoid*, GLvoid*);
typedef void(*gl20PBlendColor)(GLclampf, GLclampf, GLclampf, GLclampf);
...
typedef void(*gl20PDrawRangeElements)(GLenum, GLuint, GLuint, GLsizei, GLenum, GLvoid*);
typedef void(*gl20PTexImage3D)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, GLvoid*);
typedef void(*gl20PTexSubImage3D)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, GLvoid*);
...
typedef void(*gl20PGetCompressedTexImage)(GLenum, GLint, GLvoid*);
typedef void(*gl20PLoadTransposeMatrixd)(GLdouble*);
typedef void(*gl20PLoadTransposeMatrixf)(GLdouble*);
typedef void(*gl20PMultTransposeMatrixd)(GLdouble*);
typedef void(*gl20PMultTransposeMatrixf)(GLfloat*);
typedef void(*gl20PSampleCoverage)(GLclampf, GLboolean);
typedef void(*gl20PBlendFuncSeparate)(GLenum, GLenum, GLenum, GLenum);
typedef void(*gl20PFogCoordPointer)(GLenum, GLsizei, GLvoid*);
typedef void(*gl20PFogCoordd)(GLdouble);
typedef void(*gl20PFogCoordf)(GLfloat);
typedef void(*gl20PFogCoorddv)(GLdouble*);
typedef void(*gl20PFogCoordfv)(GLfloat*);
typedef void(*gl20PMultiDrawArrays)(GLenum, GLint*, GLsizei*, GLsizei);
typedef void(*gl20PMultiDrawElements)(GLenum, GLsizei*, GLenum, GLvoid*, GLsizei);
typedef void(*gl20PPointParameterf)(GLenum, GLfloat);
typedef void(*gl20PPointParameteri)(GLenum, GLint);
typedef void(*gl20PSecondaryColor3b)(GLbyte, GLbyte, GLbyte);
typedef void(*gl20PSecondaryColor3s)(GLshort, GLshort, GLshort);
typedef void(*gl20PSecondaryColor3i)(GLint, GLint, GLint);
typedef void(*gl20PSecondaryColor3f)(GLfloat, GLfloat, GLfloat);
typedef void(*gl20PSecondaryColor3d)(GLdouble, GLdouble, GLdouble);
typedef void(*gl20PSecondaryColor3ub)(GLubyte, GLubyte, GLubyte);
typedef void(*gl20PSecondaryColor3us)(GLushort, GLushort, GLushort);
typedef void(*gl20PSecondaryColor3ui)(GLuint, GLuint, GLuint);
typedef void(*gl20PSecondaryColor3bv)(GLbyte*);
typedef void(*gl20PSecondaryColor3sv)(GLshort*);
typedef void(*gl20PSecondaryColor3iv)(GLint*);
typedef void(*gl20PSecondaryColor3fv)(GLfloat*);
typedef void(*gl20PSecondaryColor3dv)(GLdouble*);
typedef void(*gl20PSecondaryColor3ubv)(GLubyte*);
typedef void(*gl20PSecondaryColor3usv)(GLushort*);
typedef void(*gl20PSecondaryColor3uiv)(GLuint*);
typedef void(*gl20PSecondaryColorPointer)(GLint, GLenum, GLsizei, GLvoid*);
typedef void(*gl20PWindowPos2s)(GLshort, GLshort);
typedef void(*gl20PWindowPos2i)(GLint, GLint);
typedef void(*gl20PWindowPos2f)(GLfloat, GLfloat);
typedef void(*gl20PWindowPos2d)(GLdouble, GLdouble);
typedef void(*gl20PWindowPos3s)(GLshort, GLshort, GLshort);
typedef void(*gl20PWindowPos3i)(GLint, GLint, GLint);
typedef void(*gl20PWindowPos3f)(GLfloat, GLfloat, GLfloat);
typedef void(*gl20PWindowPos3d)(GLdouble, GLdouble, GLdouble);
typedef void(*gl20PWindowPos2sv)(GLshort*);
typedef void(*gl20PWindowPos2iv)(GLint*);
typedef void(*gl20PWindowPos2fv)(GLfloat*);
typedef void(*gl20PWindowPos2dv)(GLdouble*);
typedef void(*gl20PWindowPos3sv)(GLshort*);
typedef void(*gl20PWindowPos3iv)(GLint*);
typedef void(*gl20PWindowPos3fv)(GLfloat*);
typedef void(*gl20PWindowPos3dv)(GLdouble*);
...
typedef void(*gl20PDeleteBuffers)(GLsizei, GLuint*);
typedef void(*gl20PDeleteQueries)(GLsizei, GLuint*);
typedef void(*gl20PGenBuffers)(GLsizei, GLuint*);
typedef void(*gl20PGenQueries)(GLsizei, GLuint*);
typedef void(*gl20PGetBufferParameteriv)(GLenum, GLenum, GLint*);
typedef void(*gl20PGetBufferPointerv)(GLenum, GLenum, GLvoid*);
typedef void(*gl20PGetBufferSubData)(GLenum, GLintptr, GLsizeiptr, GLvoid*);
typedef void(*gl20PGetQueryObjectiv)(GLuint, GLenum, GLint*);
typedef void(*gl20PGetQueryObjectuiv)(GLuint, GLenum, GLuint*);
typedef void(*gl20PGetQueryiv)(GLenum, GLenum, GLint*);
typedef GLboolean(*gl20PIsBuffer)(GLuint);
typedef GLboolean(*gl20PIsQuery)(GLuint);
typedef GLvoid*(*gl20PMapBuffer)(GLenum, GLenum);
typedef GLboolean(*gl20PUnmapBuffer)(GLenum);
...
typedef void(*gl20PDeleteProgram)(GLuint);
typedef void(*gl20PDeleteShader)(GLuint);
typedef void(*gl20PDetachShader)(GLuint, GLuint);
typedef void(*gl20PEnableVertexAttribArray)(GLuint);
typedef void(*gl20PDisableVertexAttribArray)(GLuint);
typedef void(*gl20PDrawBuffers)(GLsizei, GLenum*);
typedef void(*gl20PGetActiveAttrib)(GLuint, GLuint, GLsizei, GLsizei*, GLint*, GLenum*, GLchar*);
typedef void(*gl20PGetActiveUniform)(GLuint, GLuint, GLsizei, GLsizei*, GLint*, GLenum*, GLchar*);
typedef void(*gl20PGetAttachedShaders)(GLuint, GLsizei, GLsizei*, GLuint*);
typedef GLint(*gl20PGetAttribLocation)(GLuint, GLchar*);
typedef void(*gl20PGetProgramiv)(GLuint, GLenum, GLint*);
typedef void(*gl20PGetProgramInfoLog)(GLuint, GLsizei, GLsizei*, GLchar*);
typedef void(*gl20PGetShaderiv)(GLuint, GLenum, GLint*);
typedef void(*gl20PGetShaderInfoLog)(GLuint, GLsizei, GLsizei*, GLchar*);
typedef void(*gl20PGetShaderSource)(GLuint, GLsizei, GLsizei*, GLchar*);
typedef void(*gl20PGetUniformfv)(GLuint, GLint, GLfloat*);
typedef void(*gl20PGetUniformiv)(GLuint, GLint, GLint*);
typedef GLint(*gl20PGetUniformLocation)(GLuint, GLchar*);
typedef void(*gl20PGetVertexAttribdv)(GLuint, GLenum, GLdouble*);
typedef void(*gl20PGetVertexAttribfv)(GLuint, GLenum, GLfloat*);
typedef void(*gl20PGetVertexAttribiv)(GLuint, GLenum, GLint*);
typedef void(*gl20PGetVertexAttribPointerv)(GLuint, GLenum, GLvoid*);
typedef GLboolean(*gl20PIsProgram)(GLuint);
typedef GLboolean(*gl20PIsShader)(GLuint);
typedef void(*gl20PLinkProgram)(GLuint);
typedef void(*gl20PShaderSource)(GLuint, GLsizei, GLchar**, GLint*);
typedef void(*gl20PStencilFuncSeparate)(GLenum, GLenum, GLint, GLuint);
typedef void(*gl20PStencilMaskSeparate)(GLenum, GLuint);
typedef void(*gl20PStencilOpSeparate)(GLenum, GLenum, GLenum, GLenum);
typedef void(*gl20PUniform1f)(GLint, GLfloat);
typedef void(*gl20PUniform2f)(GLint, GLfloat, GLfloat);
typedef void(*gl20PUniform3f)(GLint, GLfloat, GLfloat, GLfloat);
typedef void(*gl20PUniform4f)(GLint, GLfloat, GLfloat, GLfloat, GLfloat);
typedef void(*gl20PUniform1i)(GLint, GLint);
typedef void(*gl20PUniform2i)(GLint, GLint, GLint);
typedef void(*gl20PUniform3i)(GLint, GLint, GLint, GLint);
typedef void(*gl20PUniform4i)(GLint, GLint, GLint, GLint, GLint);
typedef void(*gl20PUniform1ui)(GLint, GLuint);
typedef void(*gl20PUniform2ui)(GLint, GLuint, GLuint);
typedef void(*gl20PUniform3ui)(GLint, GLuint, GLuint, GLuint);
typedef void(*gl20PUniform4ui)(GLint, GLuint, GLuint, GLuint, GLuint);
typedef void(*gl20PUniform1fv)(GLint, GLsizei, GLfloat*);
typedef void(*gl20PUniform2fv)(GLint, GLsizei, GLfloat*);
typedef void(*gl20PUniform3fv)(GLint, GLsizei, GLfloat*);
typedef void(*gl20PUniform4fv)(GLint, GLsizei, GLfloat*);
typedef void(*gl20PUniform1iv)(GLint, GLsizei, GLint*);
typedef void(*gl20PUniform2iv)(GLint, GLsizei, GLint*);
typedef void(*gl20PUniform3iv)(GLint, GLsizei, GLint*);
typedef void(*gl20PUniform4iv)(GLint, GLsizei, GLint*);
typedef void(*gl20PUniform1uiv)(GLint, GLsizei, GLuint*);
typedef void(*gl20PUniform2uiv)(GLint, GLsizei, GLuint*);
typedef void(*gl20PUniform3uiv)(GLint, GLsizei, GLuint*);
typedef void(*gl20PUniform4uiv)(GLint, GLsizei, GLuint*);
typedef void(*gl20PUseProgram)(GLuint);
typedef void(*gl20PValidateProgram)(GLuint);
typedef void(*gl20PVertexAttribPointer)(GLuint, GLint, GLenum, GLboolean, GLsizei, GLvoid*);
typedef void(*gl20PVertexAttrib1f)(GLuint, GLfloat);
typedef void(*gl20PVertexAttrib1s)(GLuint, GLshort);
typedef void(*gl20PVertexAttrib1d)(GLuint, GLdouble);
typedef void(*gl20PVertexAttrib2f)(GLuint, GLfloat, GLfloat);
typedef void(*gl20PVertexAttrib2s)(GLuint, GLshort, GLshort);
typedef void(*gl20PVertexAttrib2d)(GLuint, GLdouble, GLdouble);
typedef void(*gl20PVertexAttrib3f)(GLuint, GLfloat, GLfloat, GLfloat);
typedef void(*gl20PVertexAttrib3s)(GLuint, GLshort, GLshort, GLshort);
typedef void(*gl20PVertexAttrib3d)(GLuint, GLdouble, GLdouble, GLdouble);
typedef void(*gl20PVertexAttrib4f)(GLuint, GLfloat, GLfloat, GLfloat, GLfloat);
typedef void(*gl20PVertexAttrib4s)(GLuint, GLshort, GLshort, GLshort, GLshort);
typedef void(*gl20PVertexAttrib4d)(GLuint, GLdouble, GLdouble, GLdouble, GLdouble);
typedef void(*gl20PVertexAttrib4Nuv)(GLuint, GLubyte, GLubyte, GLubyte, GLubyte);
typedef void(*gl20PVertexAttrib1fv)(GLuint, GLfloat*);
typedef void(*gl20PVertexAttrib1sv)(GLuint, GLshort*);
typedef void(*gl20PVertexAttrib1dv)(GLuint, GLdouble*);
typedef void(*gl20PVertexAttrib2fv)(GLuint, GLfloat*);
typedef void(*gl20PVertexAttrib2sv)(GLuint, GLshort*);
typedef void(*gl20PVertexAttrib2dv)(GLuint, GLdouble*);
typedef void(*gl20PVertexAttrib3fv)(GLuint, GLfloat*);
typedef void(*gl20PVertexAttrib3sv)(GLuint, GLshort*);
typedef void(*gl20PVertexAttrib3dv)(GLuint, GLdouble*);
typedef void(*gl20PVertexAttrib4fv)(GLuint, GLfloat*);
typedef void(*gl20PVertexAttrib4sv)(GLuint, GLshort*);
typedef void(*gl20PVertexAttrib4dv)(GLuint, GLdouble*);
typedef void(*gl20PVertexAttrib4iv)(GLuint, GLint*);
typedef void(*gl20PVertexAttrib4bv)(GLuint, GLbyte*);
typedef void(*gl20PVertexAttrib4ubv)(GLuint, GLubyte*);
typedef void(*gl20PVertexAttrib4usv)(GLuint, GLushort*);
typedef void(*gl20PVertexAttrib4uiv)(GLuint, GLuint*);
typedef void(*gl20PVertexAttrib4Nbv)(GLuint, GLbyte*);
typedef void(*gl20PVertexAttrib4Nsv)(GLuint, GLshort*);
typedef void(*gl20PVertexAttrib4Niv)(GLuint, GLint*);
typedef void(*gl20PVertexAttrib4Nubv)(GLuint, GLubyte*);
typedef void(*gl20PVertexAttrib4Nusv)(GLuint, GLushort*);
typedef void(*gl20PVertexAttrib4Nuiv)(GLuint, GLuint*);
typedef void(*gl20PUniformMatrix2fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl20PUniformMatrix3fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl20PUniformMatrix4fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl20PUniformMatrix2x3fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl20PUniformMatrix3x2fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl20PUniformMatrix2x4fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl20PUniformMatrix4x2fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl20PUniformMatrix3x4fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl20PUniformMatrix4x3fv)(GLint, GLsizei, GLboolean, GLfloat*);
...
typedef struct {
    ...
    gl20PGetConvolutionParameterfv fnGetConvolutionParameterfv;
    gl20PGetConvolutionParameteriv fnGetConvolutionParameteriv;
    ...
    gl20PGetColorTable fnGetColorTable;
    gl20PGetColorTableParameterfv fnGetColorTableParameterfv;
    gl20PGetColorTableParameteriv fnGetColorTableParameteriv;
    gl20PGetConvolutionFilter fnGetConvolutionFilter;
    gl20PGetHistogram fnGetHistogram;
    gl20PGetHistogramParameterfv fnGetHistogramParameterfv;
    gl20PGetHistogramParameteriv fnGetHistogramParameteriv;
    gl20PGetSeparableFilter fnGetSeparableFilter;
    gl20PHistogram fnHistogram;
    gl20PMinmax fnMinmax;
    gl20PMultiTexCoord1s fnMultiTexCoord1s;
    gl20PMultiTexCoord1i fnMultiTexCoord1i;
    gl20PMultiTexCoord1f fnMultiTexCoord1f;
    gl20PMultiTexCoord1d fnMultiTexCoord1d;
    gl20PMultiTexCoord2s fnMultiTexCoord2s;
    gl20PMultiTexCoord2i fnMultiTexCoord2i;
    gl20PMultiTexCoord2f fnMultiTexCoord2f;
    gl20PMultiTexCoord2d fnMultiTexCoord2d;
    gl20PMultiTexCoord3s fnMultiTexCoord3s;
    gl20PMultiTexCoord3i fnMultiTexCoord3i;
    gl20PMultiTexCoord3f fnMultiTexCoord3f;
    gl20PMultiTexCoord3d fnMultiTexCoord3d;
    gl20PMultiTexCoord4s fnMultiTexCoord4s;
    gl20PMultiTexCoord4i fnMultiTexCoord4i;
    gl20PMultiTexCoord4f fnMultiTexCoord4f;
    gl20PMultiTexCoord4d fnMultiTexCoord4d;
    gl20PMultiTexCoord1sv fnMultiTexCoord1sv;
    gl20PMultiTexCoord1iv fnMultiTexCoord1iv;
    gl20PMultiTexCoord1fv fnMultiTexCoord1fv;
    gl20PMultiTexCoord1dv fnMultiTexCoord1dv;
    gl20PMultiTexCoord2sv fnMultiTexCoord2sv;
    gl20PMultiTexCoord2iv fnMultiTexCoord2iv;
    gl20PMultiTexCoord2fv fnMultiTexCoord2fv;
    gl20PMultiTexCoord2dv fnMultiTexCoord2dv;
    gl20PMultiTexCoord3sv fnMultiTexCoord3sv;
    gl20PMultiTexCoord3iv fnMultiTexCoord3iv;
    gl20PMultiTexCoord3fv fnMultiTexCoord3fv;
    gl20PMultiTexCoord3dv fnMultiTexCoord3dv;
    gl20PMultiTexCoord4sv fnMultiTexCoord4sv;
    gl20PMultiTexCoord4iv fnMultiTexCoord4iv;
    gl20PMultiTexCoord4fv fnMultiTexCoord4fv;
    gl20PMultiTexCoord4dv fnMultiTexCoord4dv;
    gl20PResetHistogram fnResetHistogram;
    gl20PResetMinmax fnResetMinmax;
    gl20PSeparableFilter2D fnSeparableFilter2D;
    gl20PBlendColor fnBlendColor;
    gl20PBlendEquation fnBlendEquation;
    gl20PCopyTexSubImage3D fnCopyTexSubImage3D;
    gl20PDrawRangeElements fnDrawRangeElements;
    gl20PTexImage3D fnTexImage3D;
    gl20PTexSubImage3D fnTexSubImage3D;
    ...
    gl20PGetCompressedTexImage fnGetCompressedTexImage;
    gl20PLoadTransposeMatrixd fnLoadTransposeMatrixd;
    gl20PLoadTransposeMatrixf fnLoadTransposeMatrixf;
    gl20PMultTransposeMatrixd fnMultTransposeMatrixd;
    gl20PMultTransposeMatrixf fnMultTransposeMatrixf;
    gl20PSampleCoverage fnSampleCoverage;
    gl20PBlendFuncSeparate fnBlendFuncSeparate;
    gl20PFogCoordPointer fnFogCoordPointer;
    gl20PFogCoordd fnFogCoordd;
    gl20PFogCoordf fnFogCoordf;
    gl20PFogCoorddv fnFogCoorddv;
    gl20PFogCoordfv fnFogCoordfv;
    gl20PMultiDrawArrays fnMultiDrawArrays;
    gl20PMultiDrawElements fnMultiDrawElements;
    gl20PPointParameterf fnPointParameterf;
    gl20PPointParameteri fnPointParameteri;
    gl20PSecondaryColor3b fnSecondaryColor3b;
    gl20PSecondaryColor3s fnSecondaryColor3s;
    gl20PSecondaryColor3i fnSecondaryColor3i;
    gl20PSecondaryColor3f fnSecondaryColor3f;
    gl20PSecondaryColor3d fnSecondaryColor3d;
    gl20PSecondaryColor3ub fnSecondaryColor3ub;
    gl20PSecondaryColor3us fnSecondaryColor3us;
    gl20PSecondaryColor3ui fnSecondaryColor3ui;
    gl20PSecondaryColor3bv fnSecondaryColor3bv;
    gl20PSecondaryColor3sv fnSecondaryColor3sv;
    gl20PSecondaryColor3iv fnSecondaryColor3iv;
    gl20PSecondaryColor3fv fnSecondaryColor3fv;
    gl20PSecondaryColor3dv fnSecondaryColor3dv;
    gl20PSecondaryColor3ubv fnSecondaryColor3ubv;
    gl20PSecondaryColor3usv fnSecondaryColor3usv;
    gl20PSecondaryColor3uiv fnSecondaryColor3uiv;
    gl20PSecondaryColorPointer fnSecondaryColorPointer;
    gl20PWindowPos2s fnWindowPos2s;
    gl20PWindowPos2i fnWindowPos2i;
    gl20PWindowPos2f fnWindowPos2f;
    gl20PWindowPos2d fnWindowPos2d;
    gl20PWindowPos3s fnWindowPos3s;
    gl20PWindowPos3i fnWindowPos3i;
    gl20PWindowPos3f fnWindowPos3f;
    gl20PWindowPos3d fnWindowPos3d;
    gl20PWindowPos2sv fnWindowPos2sv;
    gl20PWindowPos2iv fnWindowPos2iv;
    gl20PWindowPos2fv fnWindowPos2fv;
    gl20PWindowPos2dv fnWindowPos2dv;
    gl20PWindowPos3sv fnWindowPos3sv;
    gl20PWindowPos3iv fnWindowPos3iv;
    gl20PWindowPos3fv fnWindowPos3fv;
    gl20PWindowPos3dv fnWindowPos3dv;
    gl20PBeginQuery fnBeginQuery;
    gl20PBindBuffer fnBindBuffer;
    gl20PBufferData fnBufferData;
    gl20PBufferSubData fnBufferSubData;
    gl20PDeleteBuffers fnDeleteBuffers;
    gl20PDeleteQueries fnDeleteQueries;
    gl20PGenBuffers fnGenBuffers;
    gl20PGenQueries fnGenQueries;
    gl20PGetBufferParameteriv fnGetBufferParameteriv;
    gl20PGetBufferPointerv fnGetBufferPointerv;
    gl20PGetBufferSubData fnGetBufferSubData;
    gl20PGetQueryObjectiv fnGetQueryObjectiv;
    gl20PGetQueryObjectuiv fnGetQueryObjectuiv;
    gl20PGetQueryiv fnGetQueryiv;
    gl20PIsBuffer fnIsBuffer;
    gl20PIsQuery fnIsQuery;
    gl20PMapBuffer fnMapBuffer;
    gl20PUnmapBuffer fnUnmapBuffer;
    ...
    gl20PDeleteProgram fnDeleteProgram;
    gl20PDeleteShader fnDeleteShader;
    gl20PDetachShader fnDetachShader;
    gl20PEnableVertexAttribArray fnEnableVertexAttribArray;
    gl20PDisableVertexAttribArray fnDisableVertexAttribArray;
    gl20PDrawBuffers fnDrawBuffers;
    gl20PGetActiveAttrib fnGetActiveAttrib;
    gl20PGetActiveUniform fnGetActiveUniform;
    gl20PGetAttachedShaders fnGetAttachedShaders;
    gl20PGetAttribLocation fnGetAttribLocation;
    gl20PGetProgramiv fnGetProgramiv;
    gl20PGetProgramInfoLog fnGetProgramInfoLog;
    gl20PGetShaderiv fnGetShaderiv;
    gl20PGetShaderInfoLog fnGetShaderInfoLog;
    gl20PGetShaderSource fnGetShaderSource;
    gl20PGetUniformfv fnGetUniformfv;
    gl20PGetUniformiv fnGetUniformiv;
    gl20PGetUniformLocation fnGetUniformLocation;
    gl20PGetVertexAttribdv fnGetVertexAttribdv;
    gl20PGetVertexAttribfv fnGetVertexAttribfv;
    gl20PGetVertexAttribiv fnGetVertexAttribiv;
    gl20PGetVertexAttribPointerv fnGetVertexAttribPointerv;
    gl20PIsProgram fnIsProgram;
    gl20PIsShader fnIsShader;
    gl20PLinkProgram fnLinkProgram;
    gl20PShaderSource fnShaderSource;
    gl20PStencilFuncSeparate fnStencilFuncSeparate;
    gl20PStencilMaskSeparate fnStencilMaskSeparate;
    gl20PStencilOpSeparate fnStencilOpSeparate;
    gl20PUniform1f fnUniform1f;
    gl20PUniform2f fnUniform2f;
    gl20PUniform3f fnUniform3f;
    gl20PUniform4f fnUniform4f;
    gl20PUniform1i fnUniform1i;
    gl20PUniform2i fnUniform2i;
    gl20PUniform3i fnUniform3i;
    gl20PUniform4i fnUniform4i;
    gl20PUniform1ui fnUniform1ui;
    gl20PUniform2ui fnUniform2ui;
    gl20PUniform3ui fnUniform3ui;
    gl20PUniform4ui fnUniform4ui;
    gl20PUniform1fv fnUniform1fv;
    gl20PUniform2fv fnUniform2fv;
    gl20PUniform3fv fnUniform3fv;
    gl20PUniform4fv fnUniform4fv;
    gl20PUniform1iv fnUniform1iv;
    gl20PUniform2iv fnUniform2iv;
    gl20PUniform3iv fnUniform3iv;
    gl20PUniform4iv fnUniform4iv;
    gl20PUniform1uiv fnUniform1uiv;
    gl20PUniform2uiv fnUniform2uiv;
    gl20PUniform3uiv fnUniform3uiv;
    gl20PUniform4uiv fnUniform4uiv;
    gl20PUseProgram fnUseProgram;
    gl20PValidateProgram fnValidateProgram;
    gl20PVertexAttribPointer fnVertexAttribPointer;
    gl20PVertexAttrib1f fnVertexAttrib1f;
    gl20PVertexAttrib1s fnVertexAttrib1s;
    gl20PVertexAttrib1d fnVertexAttrib1d;
    gl20PVertexAttrib2f fnVertexAttrib2f;
    gl20PVertexAttrib2s fnVertexAttrib2s;
    gl20PVertexAttrib2d fnVertexAttrib2d;
    gl20PVertexAttrib3f fnVertexAttrib3f;
    gl20PVertexAttrib3s fnVertexAttrib3s;
    gl20PVertexAttrib3d fnVertexAttrib3d;
    gl20PVertexAttrib4f fnVertexAttrib4f;
    gl20PVertexAttrib4s fnVertexAttrib4s;
    gl20PVertexAttrib4d fnVertexAttrib4d;
    gl20PVertexAttrib4Nuv fnVertexAttrib4Nuv;
    gl20PVertexAttrib1fv fnVertexAttrib1fv;
    gl20PVertexAttrib1sv fnVertexAttrib1sv;
    gl20PVertexAttrib1dv fnVertexAttrib1dv;
    gl20PVertexAttrib2fv fnVertexAttrib2fv;
    gl20PVertexAttrib2sv fnVertexAttrib2sv;
    gl20PVertexAttrib2dv fnVertexAttrib2dv;
    gl20PVertexAttrib3fv fnVertexAttrib3fv;
    gl20PVertexAttrib3sv fnVertexAttrib3sv;
    gl20PVertexAttrib3dv fnVertexAttrib3dv;
    gl20PVertexAttrib4fv fnVertexAttrib4fv;
    gl20PVertexAttrib4sv fnVertexAttrib4sv;
    gl20PVertexAttrib4dv fnVertexAttrib4dv;
    gl20PVertexAttrib4iv fnVertexAttrib4iv;
    gl20PVertexAttrib4bv fnVertexAttrib4bv;
    gl20PVertexAttrib4ubv fnVertexAttrib4ubv;
    gl20PVertexAttrib4usv fnVertexAttrib4usv;
    gl20PVertexAttrib4uiv fnVertexAttrib4uiv;
    gl20PVertexAttrib4Nbv fnVertexAttrib4Nbv;
    gl20PVertexAttrib4Nsv fnVertexAttrib4Nsv;
    gl20PVertexAttrib4Niv fnVertexAttrib4Niv;
    gl20PVertexAttrib4Nubv fnVertexAttrib4Nubv;
    gl20PVertexAttrib4Nusv fnVertexAttrib4Nusv;
    gl20PVertexAttrib4Nuiv fnVertexAttrib4Nuiv;
    gl20PUniformMatrix2fv fnUniformMatrix2fv;
    gl20PUniformMatrix3fv fnUniformMatrix3fv;
    gl20PUniformMatrix4fv fnUniformMatrix4fv;
    gl20PUniformMatrix2x3fv fnUniformMatrix2x3fv;
    gl20PUniformMatrix3x2fv fnUniformMatrix3x2fv;
    gl20PUniformMatrix2x4fv fnUniformMatrix2x4fv;
    gl20PUniformMatrix4x2fv fnUniformMatrix4x2fv;
    gl20PUniformMatrix3x4fv fnUniformMatrix3x4fv;
    gl20PUniformMatrix4x3fv fnUniformMatrix4x3fv;
} gl20Context;
