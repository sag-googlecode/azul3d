...
func New() *Context {
	...
	glc.Bitmap = func(width, height int32, xorig, yorig, xmove, ymove float32, bitmap []uint8) {
		C.gl20Bitmap(glc.context, C.GLsizei(width), C.GLsizei(height), C.GLfloat(xorig), C.GLfloat(yorig), C.GLfloat(xmove), C.GLfloat(ymove), (*C.GLubyte)(unsafe.Pointer(&bitmap[0])))
	}
	...
	glc.ClipPlane = func(plane uint32, equation []float64) {
		C.gl20ClipPlane(glc.context, C.GLenum(plane), (*C.GLdouble)(unsafe.Pointer(&equation[0])))
	}
	...
	glc.Color3bv = func(v []int8) {
		C.gl20Color3bv(glc.context, (*C.GLbyte)(unsafe.Pointer(&v[0])))
	}

	glc.Color3dv = func(v []float64) {
		C.gl20Color3dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.Color3fv = func(v []float32) {
		C.gl20Color3fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.Color3iv = func(v []int32) {
		C.gl20Color3iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.Color3sv = func(v []int16) {
		C.gl20Color3sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.Color3ubv = func(v []uint8) {
		C.gl20Color3ubv(glc.context, (*C.GLubyte)(unsafe.Pointer(&v[0])))
	}

	glc.Color3uiv = func(v []uint32) {
		C.gl20Color3uiv(glc.context, (*C.GLuint)(unsafe.Pointer(&v[0])))
	}

	glc.Color3usv = func(v []uint16) {
		C.gl20Color3usv(glc.context, (*C.GLushort)(unsafe.Pointer(&v[0])))
	}

	glc.Color4bv = func(v []int8) {
		C.gl20Color4bv(glc.context, (*C.GLbyte)(unsafe.Pointer(&v[0])))
	}

	glc.Color4dv = func(v []float64) {
		C.gl20Color4dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.Color4fv = func(v []float32) {
		C.gl20Color4fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.Color4iv = func(v []int32) {
		C.gl20Color4iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.Color4sv = func(v []int16) {
		C.gl20Color4sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.Color4ubv = func(v []uint8) {
		C.gl20Color4ubv(glc.context, (*C.GLubyte)(unsafe.Pointer(&v[0])))
	}

	glc.Color4uiv = func(v []uint32) {
		C.gl20Color4uiv(glc.context, (*C.GLuint)(unsafe.Pointer(&v[0])))
	}

	glc.Color4usv = func(v []uint16) {
		C.gl20Color4usv(glc.context, (*C.GLushort)(unsafe.Pointer(&v[0])))
	}
	...
	glc.ColorTableParameterfv = func(target, pname uint32, params []float32) {
		C.gl20ColorTableParameterfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.ColorTableParameteriv = func(target, pname uint32, params []int32) {
		C.gl20ColorTableParameteriv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.DrawPixels = func(width, height int32, format, Type uint32, pixels unsafe.Pointer) {
		C.gl20DrawPixels(glc.context, C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLenum(Type), pixels)
	}
	...
	glc.EdgeFlagv = func(flag []bool) {
		C.gl20EdgeFlagv(glc.context, (*C.GLboolean)(unsafe.Pointer(&flag[0])))
	}
	...
	glc.EvalCoord1dv = func(u []float64) {
		C.gl20EvalCoord1dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&u[0])))
	}

	glc.EvalCoord1fv = func(u []float32) {
		C.gl20EvalCoord1fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&u[0])))
	}

	glc.EvalCoord2dv = func(u []float64) {
		C.gl20EvalCoord2dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&u[0])))
	}

	glc.EvalCoord2fv = func(u []float32) {
		C.gl20EvalCoord2fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&u[0])))
	}
	...
	glc.FeedbackBuffer = func(size int32, Type uint32, buffer []float32) {
		C.gl20FeedbackBuffer(glc.context, C.GLsizei(size), C.GLenum(Type), (*C.GLfloat)(unsafe.Pointer(&buffer[0])))
	}
	...
	glc.Fogfv = func(pname uint32, params []float32) {
		C.gl20Fogfv(glc.context, C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.Fogiv = func(pname uint32, params []int32) {
		C.gl20Fogiv(glc.context, C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.GetBooleanv = func(pname uint32, params []bool) {
		C.gl20GetBooleanv(glc.context, C.GLenum(pname), (*C.GLboolean)(unsafe.Pointer(&params[0])))
	}

	glc.GetDoublev = func(pname uint32, params []float64) {
		C.gl20GetDoublev(glc.context, C.GLenum(pname), (*C.GLdouble)(unsafe.Pointer(&params[0])))
	}

	glc.GetFloatv = func(pname uint32, params []float32) {
		C.gl20GetFloatv(glc.context, C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetIntegerv = func(pname uint32, params []int32) {
		C.gl20GetIntegerv(glc.context, C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}

	glc.GetClipPlane = func(plane uint32, equation []float64) {
		C.gl20GetClipPlane(glc.context, C.GLenum(plane), (*C.GLdouble)(unsafe.Pointer(&equation[0])))
	}
	...
	glc.GetLightfv = func(light, pname uint32, params []float32) {
		C.gl20GetLightfv(glc.context, C.GLenum(light), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetLightiv = func(light, pname uint32, params []int32) {
		C.gl20GetLightiv(glc.context, C.GLenum(light), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}

	glc.GetMapdv = func(target, query uint32, v []float64) {
		C.gl20GetMapdv(glc.context, C.GLenum(target), C.GLenum(query), (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.GetMapfv = func(target, query uint32, v []float32) {
		C.gl20GetMapfv(glc.context, C.GLenum(target), C.GLenum(query), (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.GetMapiv = func(target, query uint32, v []int32) {
		C.gl20GetMapiv(glc.context, C.GLenum(target), C.GLenum(query), (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.GetMaterialfv = func(face, pname uint32, params []float32) {
		C.gl20GetMaterialfv(glc.context, C.GLenum(face), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetMaterialiv = func(face, pname uint32, params []int32) {
		C.gl20GetMaterialiv(glc.context, C.GLenum(face), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}

	glc.GetPixelMapfv = func(Map uint32, values []float32) {
		C.gl20GetPixelMapfv(glc.context, C.GLenum(Map), (*C.GLfloat)(unsafe.Pointer(&values[0])))
	}

	glc.GetPixelMapuiv = func(Map uint32, values []uint32) {
		C.gl20GetPixelMapuiv(glc.context, C.GLenum(Map), (*C.GLuint)(unsafe.Pointer(&values[0])))
	}

	glc.GetPixelMapusv = func(Map uint32, values []uint16) {
		C.gl20GetPixelMapusv(glc.context, C.GLenum(Map), (*C.GLushort)(unsafe.Pointer(&values[0])))
	}

	glc.GetPolygonStipple = func(mask []uint8) {
		C.gl20GetPolygonStipple(glc.context, (*C.GLubyte)(unsafe.Pointer(&mask[0])))
	}
	...
	glc.GetTexEnvfv = func(target, pname uint32, params []float32) {
		C.gl20GetTexEnvfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexEnviv = func(target, pname uint32, params []int32) {
		C.gl20GetTexEnviv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexGendv = func(coord, pname uint32, params []float64) {
		C.gl20GetTexGendv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLdouble)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexGenfv = func(coord, pname uint32, params []float32) {
		C.gl20GetTexGenfv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexGeniv = func(coord, pname uint32, params []int32) {
		C.gl20GetTexGeniv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.GetTexLevelParameterfv = func(target uint32, level int32, pname uint32, params []float32) {
		C.gl20GetTexLevelParameterfv(glc.context, C.GLenum(target), C.GLint(level), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexLevelParameteriv = func(target uint32, level int32, pname uint32, params []int32) {
		C.gl20GetTexLevelParameteriv(glc.context, C.GLenum(target), C.GLint(level), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexParameterfv = func(target, pname uint32, params []float32) {
		C.gl20GetTexParameterfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.GetTexParameteriv = func(target, pname uint32, params []int32) {
		C.gl20GetTexParameteriv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.Indexdv = func(c []float64) {
		C.gl20Indexdv(glc.context, (*C.GLdouble)(unsafe.Pointer(&c[0])))
	}

	glc.Indexfv = func(c []float32) {
		C.gl20Indexfv(glc.context, (*C.GLfloat)(unsafe.Pointer(&c[0])))
	}

	glc.Indexiv = func(c []int32) {
		C.gl20Indexiv(glc.context, (*C.GLint)(unsafe.Pointer(&c[0])))
	}

	glc.Indexsv = func(c []int16) {
		C.gl20Indexsv(glc.context, (*C.GLshort)(unsafe.Pointer(&c[0])))
	}

	glc.Indexubv = func(c []uint8) {
		C.gl20Indexubv(glc.context, (*C.GLubyte)(unsafe.Pointer(&c[0])))
	}
	...
	glc.Lightfv = func(light, pname uint32, params []float32) {
		C.gl20Lightfv(glc.context, C.GLenum(light), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.Lightiv = func(light, pname uint32, params []int32) {
		C.gl20Lightiv(glc.context, C.GLenum(light), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.LightModelfv = func(pname uint32, params []float32) {
		C.gl20LightModelfv(glc.context, C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.LightModeliv = func(pname uint32, params []int32) {
		C.gl20LightModeliv(glc.context, C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.LoadMatrixd = func(m []float64) {
		C.gl20LoadMatrixd(glc.context, (*C.GLdouble)(unsafe.Pointer(&m[0])))
	}

	glc.LoadMatrixf = func(m []float32) {
		C.gl20LoadMatrixf(glc.context, (*C.GLfloat)(unsafe.Pointer(&m[0])))
	}
	...
	glc.Map1d = func(target uint32, u1, u2 float64, stride, order int32, points []float64) {
		C.gl20Map1d(glc.context, C.GLenum(target), C.GLdouble(u1), C.GLdouble(u2), C.GLint(stride), C.GLint(order), (*C.GLdouble)(unsafe.Pointer(&points[0])))
	}

	glc.Map1f = func(target uint32, u1, u2 float32, stride, order int32, points []float32) {
		C.gl20Map1f(glc.context, C.GLenum(target), C.GLfloat(u1), C.GLfloat(u2), C.GLint(stride), C.GLint(order), (*C.GLfloat)(unsafe.Pointer(&points[0])))
	}

	glc.Map2d = func(target uint32, u1, u2 float64, ustride, uorder int32, v1, v2 float64, vstride, vorder int32, points []float64) {
		C.gl20Map2d(glc.context, C.GLenum(target), C.GLdouble(u1), C.GLdouble(u2), C.GLint(ustride), C.GLint(uorder), C.GLdouble(v1), C.GLdouble(v2), C.GLint(vstride), C.GLint(vorder), (*C.GLdouble)(unsafe.Pointer(&points[0])))
	}

	glc.Map2f = func(target uint32, u1, u2 float32, ustride, uorder int32, v1, v2 float32, vstride, vorder int32, points []float32) {
		C.gl20Map2f(glc.context, C.GLenum(target), C.GLfloat(u1), C.GLfloat(u2), C.GLint(ustride), C.GLint(uorder), C.GLfloat(v1), C.GLfloat(v2), C.GLint(vstride), C.GLint(vorder), (*C.GLfloat)(unsafe.Pointer(&points[0])))
	}
	...
	glc.Materialfv = func(face, pname uint32, params []float32) {
		C.gl20Materialfv(glc.context, C.GLenum(face), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.Materialiv = func(face, pname uint32, params []int32) {
		C.gl20Materialiv(glc.context, C.GLenum(face), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.MultMatrixd = func(m []float64) {
		C.gl20MultMatrixd(glc.context, (*C.GLdouble)(unsafe.Pointer(&m[0])))
	}

	glc.MultMatrixf = func(m []float32) {
		C.gl20MultMatrixf(glc.context, (*C.GLfloat)(unsafe.Pointer(&m[0])))
	}
	...
	glc.Normal3bv = func(v []int8) {
		C.gl20Normal3bv(glc.context, (*C.GLbyte)(unsafe.Pointer(&v[0])))
	}

	glc.Normal3dv = func(v []float64) {
		C.gl20Normal3dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.Normal3fv = func(v []float32) {
		C.gl20Normal3fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.Normal3iv = func(v []int32) {
		C.gl20Normal3iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.Normal3sv = func(v []int16) {
		C.gl20Normal3sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}
	...
	glc.PixelMapfv = func(Map uint32, mapsize int32, values []float32) {
		C.gl20PixelMapfv(glc.context, C.GLenum(Map), C.GLsizei(mapsize), (*C.GLfloat)(unsafe.Pointer(&values[0])))
	}

	glc.PixelMapuiv = func(Map uint32, mapsize int32, values []uint32) {
		C.gl20PixelMapuiv(glc.context, C.GLenum(Map), C.GLsizei(mapsize), (*C.GLuint)(unsafe.Pointer(&values[0])))
	}

	glc.PixelMapusv = func(Map uint32, mapsize int32, values []uint16) {
		C.gl20PixelMapusv(glc.context, C.GLenum(Map), C.GLsizei(mapsize), (*C.GLushort)(unsafe.Pointer(&values[0])))
	}
	...
	glc.PolygonStipple = func(mask []uint8) {
		C.gl20PolygonStipple(glc.context, (*C.GLubyte)(unsafe.Pointer(&mask[0])))
	}

	glc.PrioritizeTextures = func(n int32, textures []uint32, priorities []float32) {
		C.gl20PrioritizeTextures(glc.context, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(&textures[0])), (*C.GLclampf)(unsafe.Pointer(&priorities[0])))
	}
	...
	glc.RasterPos2dv = func(v []float64) {
		C.gl20RasterPos2dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos2fv = func(v []float32) {
		C.gl20RasterPos2fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos2iv = func(v []int32) {
		C.gl20RasterPos2iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos2sv = func(v []int16) {
		C.gl20RasterPos2sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos3dv = func(v []float64) {
		C.gl20RasterPos3dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos3fv = func(v []float32) {
		C.gl20RasterPos3fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos3iv = func(v []int32) {
		C.gl20RasterPos3iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos3sv = func(v []int16) {
		C.gl20RasterPos3sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos4dv = func(v []float64) {
		C.gl20RasterPos4dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos4fv = func(v []float32) {
		C.gl20RasterPos4fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos4iv = func(v []int32) {
		C.gl20RasterPos4iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.RasterPos4sv = func(v []int16) {
		C.gl20RasterPos4sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}
	...
	glc.Rectdv = func(v1, v2 []float64) {
		C.gl20Rectdv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v1[0])), (*C.GLdouble)(unsafe.Pointer(&v2[0])))
	}

	glc.Rectfv = func(v1, v2 []float32) {
		C.gl20Rectfv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v1[0])), (*C.GLfloat)(unsafe.Pointer(&v2[0])))
	}

	glc.Rectiv = func(v1, v2 []int32) {
		C.gl20Rectiv(glc.context, (*C.GLint)(unsafe.Pointer(&v1[0])), (*C.GLint)(unsafe.Pointer(&v2[0])))
	}

	glc.Rectsv = func(v1, v2 []int16) {
		C.gl20Rectsv(glc.context, (*C.GLshort)(unsafe.Pointer(&v1[0])), (*C.GLshort)(unsafe.Pointer(&v2[0])))
	}
	...
	glc.SelectBuffer = func(size int32, buffer []uint32) {
		C.gl20SelectBuffer(glc.context, C.GLsizei(size), (*C.GLuint)(unsafe.Pointer(&buffer[0])))
	}
	...
	glc.TexCoord1dv = func(v []float64) {
		C.gl20TexCoord1dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord1fv = func(v []float32) {
		C.gl20TexCoord1fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord1iv = func(v []int32) {
		C.gl20TexCoord1iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord1sv = func(v []int16) {
		C.gl20TexCoord1sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord2dv = func(v []float64) {
		C.gl20TexCoord2dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord2fv = func(v []float32) {
		C.gl20TexCoord2fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord2iv = func(v []int32) {
		C.gl20TexCoord2iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord2sv = func(v []int16) {
		C.gl20TexCoord2sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord3dv = func(v []float64) {
		C.gl20TexCoord3dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord3fv = func(v []float32) {
		C.gl20TexCoord3fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord3iv = func(v []int32) {
		C.gl20TexCoord3iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord3sv = func(v []int16) {
		C.gl20TexCoord3sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord4dv = func(v []float64) {
		C.gl20TexCoord4dv(glc.context, (*C.GLdouble)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord4fv = func(v []float32) {
		C.gl20TexCoord4fv(glc.context, (*C.GLfloat)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord4iv = func(v []int32) {
		C.gl20TexCoord4iv(glc.context, (*C.GLint)(unsafe.Pointer(&v[0])))
	}

	glc.TexCoord4sv = func(v []int16) {
		C.gl20TexCoord4sv(glc.context, (*C.GLshort)(unsafe.Pointer(&v[0])))
	}
	...
	glc.TexEnvfv = func(target, pname uint32, params []float32) {
		C.gl20TexEnvfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.TexEnviv = func(target, pname uint32, params []int32) {
		C.gl20TexEnviv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.TexGendv = func(coord, pname uint32, params []float64) {
		C.gl20TexGendv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLdouble)(unsafe.Pointer(&params[0])))
	}

	glc.TexGenfv = func(coord, pname uint32, params []float32) {
		C.gl20TexGenfv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.TexGeniv = func(coord, pname uint32, params []int32) {
		C.gl20TexGeniv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.TexImage3DEXT = func(target uint32, level, internalformat int32, width, height, depth int32, border int32, format, Type uint32, pixels unsafe.Pointer) {
		C.gl20TexImage3DEXT(glc.context, C.GLenum(target), C.GLint(level), C.GLint(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLint(border), C.GLenum(format), C.GLenum(Type), pixels)
	}
	...
	glc.TexParameterfv = func(target, pname uint32, params []float32) {
		C.gl20TexParameterfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
	}

	glc.TexParameteriv = func(target, pname uint32, params []int32) {
		C.gl20TexParameteriv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
	}
	...
	glc.TexSubImage3DEXT = func(target uint32, level, xoffset, yoffset, zoffset int32, width, height, depth int32, format, Type uint32, pixels unsafe.Pointer) {
		C.gl20TexSubImage3DEXT(glc.context, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLint(yoffset), C.GLint(zoffset), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLenum(format), C.GLenum(Type), pixels)
	}
	...
	glc.DeleteTextures = func(n int32, textures []uint32) {
		C.gl20DeleteTextures(glc.context, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(&textures[0])))
	}

	glc.GenTextures = func(n int32, textures []uint32) {
		C.gl20GenTextures(glc.context, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(&textures[0])))
	}
	...
	glc.BlendColorEXT = func(red, green, blue, alpha float32) {
		C.gl20BlendColorEXT(glc.context, C.GLclampf(red), C.GLclampf(green), C.GLclampf(blue), C.GLclampf(alpha))
	}
