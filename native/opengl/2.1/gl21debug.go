...
func versionSupported(glc *Context) bool {
	...
	if len(ver) > 0 {
		n, wantedMajor, wantedMinor, wantedRev := parseVersions("2.1")
		if n < 2 {
...
func New() *Context {
	...
	glc.Bitmap = func(width, height int32, xorig, yorig, xmove, ymove float32, bitmap *uint8) {
		...
		defer glc.trace(fmtCall)
		C.gl21Bitmap(glc.context, C.GLsizei(width), C.GLsizei(height), C.GLfloat(xorig), C.GLfloat(yorig), C.GLfloat(xmove), C.GLfloat(ymove), (*C.GLubyte)(unsafe.Pointer(bitmap)))
	}
	...
	glc.ClipPlane = func(plane Enum, equation *float64) {
		...
		defer glc.trace(fmtCall)
		C.gl21ClipPlane(glc.context, C.GLenum(plane), (*C.GLdouble)(unsafe.Pointer(equation)))
	}
	...
	glc.DepthMask = func(flag bool) {
		...
		defer glc.trace(fmtCall)
		C.gl21DepthMask(glc.context, boolToGL(flag))
	}
	...
	glc.DrawPixels = func(width, height int32, format, Type Enum, data unsafe.Pointer) {
		...
		defer glc.trace(fmtCall)
		C.gl21DrawPixels(glc.context, C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLenum(Type), data)
	}
	...
	glc.EdgeFlagv = func(flag *bool) {
		...
		defer glc.trace(fmtCall)
		C.gl21EdgeFlagv(glc.context, (*C.GLboolean)(unsafe.Pointer(flag)))
	}
	...
	glc.EvalCoord1dv = func(u *float64) {
		...
		defer glc.trace(fmtCall)
		C.gl21EvalCoord1dv(glc.context, (*C.GLdouble)(unsafe.Pointer(u)))
	}

	glc.EvalCoord1fv = func(u *float32) {
		fmtCall := fmt.Sprintf("EvalCoord1fv(%v)", u)
		defer glc.trace(fmtCall)
		C.gl21EvalCoord1fv(glc.context, (*C.GLfloat)(unsafe.Pointer(u)))
	}

	glc.EvalCoord2dv = func(u *float64) {
		fmtCall := fmt.Sprintf("EvalCoord2dv(%v)", u)
		defer glc.trace(fmtCall)
		C.gl21EvalCoord2dv(glc.context, (*C.GLdouble)(unsafe.Pointer(u)))
	}

	glc.EvalCoord2fv = func(u *float32) {
		fmtCall := fmt.Sprintf("EvalCoord2fv(%v)", u)
		defer glc.trace(fmtCall)
		C.gl21EvalCoord2fv(glc.context, (*C.GLfloat)(unsafe.Pointer(u)))
	}
	...
	glc.FeedbackBuffer = func(size int32, Type Enum, buffer *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21FeedbackBuffer(glc.context, C.GLsizei(size), C.GLenum(Type), (*C.GLfloat)(unsafe.Pointer(buffer)))
	}
	...
	glc.Fogfv = func(pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21Fogfv(glc.context, C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}

	glc.Fogiv = func(pname Enum, params *int32) {
		fmtCall := fmt.Sprintf("Fogiv(%v, %v)", pname, params)
		defer glc.trace(fmtCall)
		C.gl21Fogiv(glc.context, C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.GetTexEnvfv = func(target, pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetTexEnvfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}

	glc.GetTexEnviv = func(target, pname Enum, params *int32) {
		fmtCall := fmt.Sprintf("GetTexEnviv(%v, %v, %v)", target, pname, params)
		defer glc.trace(fmtCall)
		C.gl21GetTexEnviv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}

	glc.GetTexGendv = func(coord, pname Enum, params *float64) {
		fmtCall := fmt.Sprintf("GetTexGendv(%v, %v, %v)", coord, pname, params)
		defer glc.trace(fmtCall)
		C.gl21GetTexGendv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLdouble)(unsafe.Pointer(params)))
	}

	glc.GetTexGenfv = func(coord, pname Enum, params *float32) {
		fmtCall := fmt.Sprintf("GetTexGenfv(%v, %v, %v)", coord, pname, params)
		defer glc.trace(fmtCall)
		C.gl21GetTexGenfv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}

	glc.GetTexGeniv = func(coord, pname Enum, params *int32) {
		fmtCall := fmt.Sprintf("GetTexGeniv(%v, %v, %v)", coord, pname, params)
		defer glc.trace(fmtCall)
		C.gl21GetTexGeniv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.GetTexLevelParameterfv = func(target Enum, level int32, pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetTexLevelParameterfv(glc.context, C.GLenum(target), C.GLint(level), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}
	...
	glc.GetTexLevelParameteriv = func(target Enum, level int32, pname Enum, params *int32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetTexLevelParameteriv(glc.context, C.GLenum(target), C.GLint(level), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.GetTexParameterfv = func(target, pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetTexParameterfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}

	glc.GetTexParameteriv = func(target, pname Enum, params *int32) {
		fmtCall := fmt.Sprintf("GetTexParameteriv(%v, %v, %v)", target, pname, params)
		defer glc.trace(fmtCall)
		C.gl21GetTexParameteriv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.Indexdv = func(c *float64) {
		...
		defer glc.trace(fmtCall)
		C.gl21Indexdv(glc.context, (*C.GLdouble)(unsafe.Pointer(c)))
	}

	glc.Indexfv = func(c *float32) {
		fmtCall := fmt.Sprintf("Indexfv(%v)", c)
		defer glc.trace(fmtCall)
		C.gl21Indexfv(glc.context, (*C.GLfloat)(unsafe.Pointer(c)))
	}

	glc.Indexiv = func(c *int32) {
		fmtCall := fmt.Sprintf("Indexiv(%v)", c)
		defer glc.trace(fmtCall)
		C.gl21Indexiv(glc.context, (*C.GLint)(unsafe.Pointer(c)))
	}

	glc.Indexsv = func(c *int16) {
		fmtCall := fmt.Sprintf("Indexsv(%v)", c)
		defer glc.trace(fmtCall)
		C.gl21Indexsv(glc.context, (*C.GLshort)(unsafe.Pointer(c)))
	}
	...
	glc.Lightfv = func(light, pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21Lightfv(glc.context, C.GLenum(light), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}

	glc.Lightiv = func(light, pname Enum, params *int32) {
		fmtCall := fmt.Sprintf("Lightiv(%v, %v, %v)", light, pname, params)
		defer glc.trace(fmtCall)
		C.gl21Lightiv(glc.context, C.GLenum(light), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.LightModelfv = func(pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21LightModelfv(glc.context, C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}

	glc.LightModeliv = func(pname Enum, params *int32) {
		fmtCall := fmt.Sprintf("LightModeliv(%v, %v)", pname, params)
		defer glc.trace(fmtCall)
		C.gl21LightModeliv(glc.context, C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.LoadMatrixd = func(m *float64) {
		...
		defer glc.trace(fmtCall)
		C.gl21LoadMatrixd(glc.context, (*C.GLdouble)(unsafe.Pointer(m)))
	}

	glc.LoadMatrixf = func(m *float32) {
		fmtCall := fmt.Sprintf("LoadMatrixf(%v)", m)
		defer glc.trace(fmtCall)
		C.gl21LoadMatrixf(glc.context, (*C.GLfloat)(unsafe.Pointer(m)))
	}
	...
	glc.Map1d = func(target Enum, u1, u2 float64, stride, order int32, points *float64) {
		...
		defer glc.trace(fmtCall)
		C.gl21Map1d(glc.context, C.GLenum(target), C.GLdouble(u1), C.GLdouble(u2), C.GLint(stride), C.GLint(order), (*C.GLdouble)(unsafe.Pointer(points)))
	}
	...
	glc.Map1f = func(target Enum, u1, u2 float32, stride, order int32, points *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21Map1f(glc.context, C.GLenum(target), C.GLfloat(u1), C.GLfloat(u2), C.GLint(stride), C.GLint(order), (*C.GLfloat)(unsafe.Pointer(points)))
	}
	...
	glc.Map2d = func(target Enum, u1, u2 float64, ustride, uorder int32, v1, v2 float64, vstride, vorder int32, points *float64) {
		...
		defer glc.trace(fmtCall)
		C.gl21Map2d(glc.context, C.GLenum(target), C.GLdouble(u1), C.GLdouble(u2), C.GLint(ustride), C.GLint(uorder), C.GLdouble(v1), C.GLdouble(v2), C.GLint(vstride), C.GLint(vorder), (*C.GLdouble)(unsafe.Pointer(points)))
	}
	...
	glc.Map2f = func(target Enum, u1, u2 float32, ustride, uorder int32, v1, v2 float32, vstride, vorder int32, points *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21Map2f(glc.context, C.GLenum(target), C.GLfloat(u1), C.GLfloat(u2), C.GLint(ustride), C.GLint(uorder), C.GLfloat(v1), C.GLfloat(v2), C.GLint(vstride), C.GLint(vorder), (*C.GLfloat)(unsafe.Pointer(points)))
	}
	...
	glc.Materialfv = func(face, pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21Materialfv(glc.context, C.GLenum(face), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}

	glc.Materialiv = func(face, pname Enum, params *int32) {
		fmtCall := fmt.Sprintf("Materialiv(%v, %v, %v)", face, pname, params)
		defer glc.trace(fmtCall)
		C.gl21Materialiv(glc.context, C.GLenum(face), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.MultMatrixd = func(m *float64) {
		...
		defer glc.trace(fmtCall)
		C.gl21MultMatrixd(glc.context, (*C.GLdouble)(unsafe.Pointer(m)))
	}

	glc.MultMatrixf = func(m *float32) {
		fmtCall := fmt.Sprintf("MultMatrixf(%v)", m)
		defer glc.trace(fmtCall)
		C.gl21MultMatrixf(glc.context, (*C.GLfloat)(unsafe.Pointer(m)))
	}
	...
	glc.Normal3bv = func(v *int8) {
		...
		defer glc.trace(fmtCall)
		C.gl21Normal3bv(glc.context, (*C.GLbyte)(unsafe.Pointer(v)))
	}

	glc.Normal3dv = func(v *float64) {
		fmtCall := fmt.Sprintf("Normal3dv(%v)", v)
		defer glc.trace(fmtCall)
		C.gl21Normal3dv(glc.context, (*C.GLdouble)(unsafe.Pointer(v)))
	}

	glc.Normal3fv = func(v *float32) {
		fmtCall := fmt.Sprintf("Normal3fv(%v)", v)
		defer glc.trace(fmtCall)
		C.gl21Normal3fv(glc.context, (*C.GLfloat)(unsafe.Pointer(v)))
	}

	glc.Normal3iv = func(v *int32) {
		fmtCall := fmt.Sprintf("Normal3iv(%v)", v)
		defer glc.trace(fmtCall)
		C.gl21Normal3iv(glc.context, (*C.GLint)(unsafe.Pointer(v)))
	}

	glc.Normal3sv = func(v *int16) {
		fmtCall := fmt.Sprintf("Normal3sv(%v)", v)
		defer glc.trace(fmtCall)
		C.gl21Normal3sv(glc.context, (*C.GLshort)(unsafe.Pointer(v)))
	}
	...
	glc.PixelMapfv = func(Map Enum, mapsize int32, values *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21PixelMapfv(glc.context, C.GLenum(Map), C.GLsizei(mapsize), (*C.GLfloat)(unsafe.Pointer(values)))
	}

	glc.PixelMapuiv = func(Map Enum, mapsize int32, values *uint32) {
		fmtCall := fmt.Sprintf("PixelMapuiv(%v, %v, %v)", Map, mapsize, values)
		defer glc.trace(fmtCall)
		C.gl21PixelMapuiv(glc.context, C.GLenum(Map), C.GLsizei(mapsize), (*C.GLuint)(unsafe.Pointer(values)))
	}

	glc.PixelMapusv = func(Map Enum, mapsize int32, values *uint16) {
		fmtCall := fmt.Sprintf("PixelMapusv(%v, %v, %v)", Map, mapsize, values)
		defer glc.trace(fmtCall)
		C.gl21PixelMapusv(glc.context, C.GLenum(Map), C.GLsizei(mapsize), (*C.GLushort)(unsafe.Pointer(values)))
	}
	...
	glc.PolygonStipple = func(mask *uint8) {
		...
		defer glc.trace(fmtCall)
		C.gl21PolygonStipple(glc.context, (*C.GLubyte)(unsafe.Pointer(mask)))
	}
	...
	glc.Rectdv = func(v1, v2 *float64) {
		...
		defer glc.trace(fmtCall)
		C.gl21Rectdv(glc.context, (*C.GLdouble)(unsafe.Pointer(v1)), (*C.GLdouble)(unsafe.Pointer(v2)))
	}

	glc.Rectfv = func(v1, v2 *float32) {
		fmtCall := fmt.Sprintf("Rectfv(%v, %v)", v1, v2)
		defer glc.trace(fmtCall)
		C.gl21Rectfv(glc.context, (*C.GLfloat)(unsafe.Pointer(v1)), (*C.GLfloat)(unsafe.Pointer(v2)))
	}

	glc.Rectiv = func(v1, v2 *int32) {
		fmtCall := fmt.Sprintf("Rectiv(%v, %v)", v1, v2)
		defer glc.trace(fmtCall)
		C.gl21Rectiv(glc.context, (*C.GLint)(unsafe.Pointer(v1)), (*C.GLint)(unsafe.Pointer(v2)))
	}

	glc.Rectsv = func(v1, v2 *int16) {
		fmtCall := fmt.Sprintf("Rectsv(%v, %v)", v1, v2)
		defer glc.trace(fmtCall)
		C.gl21Rectsv(glc.context, (*C.GLshort)(unsafe.Pointer(v1)), (*C.GLshort)(unsafe.Pointer(v2)))
	}
	...
	glc.SelectBuffer = func(size int32, buffer *uint32) {
		...
		defer glc.trace(fmtCall)
		C.gl21SelectBuffer(glc.context, C.GLsizei(size), (*C.GLuint)(unsafe.Pointer(buffer)))
	}
	...
	glc.TexEnvfv = func(target, pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21TexEnvfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}

	glc.TexEnviv = func(target, pname Enum, params *int32) {
		fmtCall := fmt.Sprintf("TexEnviv(%v, %v, %v)", target, pname, params)
		defer glc.trace(fmtCall)
		C.gl21TexEnviv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.TexGendv = func(coord, pname Enum, params *float64) {
		...
		defer glc.trace(fmtCall)
		C.gl21TexGendv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLdouble)(unsafe.Pointer(params)))
	}

	glc.TexGenfv = func(coord, pname Enum, params *float32) {
		fmtCall := fmt.Sprintf("TexGenfv(%v, %v, %v)", coord, pname, params)
		defer glc.trace(fmtCall)
		C.gl21TexGenfv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}

	glc.TexGeniv = func(coord, pname Enum, params *int32) {
		fmtCall := fmt.Sprintf("TexGeniv(%v, %v, %v)", coord, pname, params)
		defer glc.trace(fmtCall)
		C.gl21TexGeniv(glc.context, C.GLenum(coord), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.TexParameterfv = func(target, pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21TexParameterfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}

	glc.TexParameteriv = func(target, pname Enum, params *int32) {
		fmtCall := fmt.Sprintf("TexParameteriv(%v, %v, %v)", target, pname, params)
		defer glc.trace(fmtCall)
		C.gl21TexParameteriv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.GetConvolutionParameterfv = func(target, pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetConvolutionParameterfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}
	...
	glc.GetConvolutionParameteriv = func(target, pname Enum, params *int32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetConvolutionParameteriv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.DeleteTextures = func(n int32, textures *uint32) {
		...
		defer glc.trace(fmtCall)
		C.gl21DeleteTextures(glc.context, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(textures)))
	}

	glc.GenTextures = func(n int32, textures *uint32) {
		fmtCall := fmt.Sprintf("GenTextures(%v, %v)", n, textures)
		defer glc.trace(fmtCall)
		C.gl21GenTextures(glc.context, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(textures)))
	}
	...
	glc.Indexubv = func(c *uint8) {
		...
		defer glc.trace(fmtCall)
		C.gl21Indexubv(glc.context, (*C.GLubyte)(unsafe.Pointer(c)))
	}
	...
	glc.PrioritizeTextures = func(n int32, textures *uint32, priorities *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21PrioritizeTextures(glc.context, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(textures)), (*C.GLclampf)(unsafe.Pointer(priorities)))
	}
	...
	glc.ColorTableParameterfv = func(target, pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21ColorTableParameterfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}
	...
	glc.ColorTableParameteriv = func(target, pname Enum, params *int32) {
		...
		defer glc.trace(fmtCall)
		C.gl21ColorTableParameteriv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.GetColorTable = func(target, format, Type Enum, table unsafe.Pointer) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetColorTable(glc.context, C.GLenum(target), C.GLenum(format), C.GLenum(Type), table)
	}
	...
	glc.GetColorTableParameterfv = func(target, pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetColorTableParameterfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}
	...
	glc.GetColorTableParameteriv = func(target, pname Enum, params *int32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetColorTableParameteriv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.GetConvolutionFilter = func(target, format, Type Enum, image unsafe.Pointer) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetConvolutionFilter(glc.context, C.GLenum(target), C.GLenum(format), C.GLenum(Type), image)
	}
	...
	glc.GetHistogram = func(target Enum, reset bool, format, Type Enum, values unsafe.Pointer) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetHistogram(glc.context, C.GLenum(target), boolToGL(reset), C.GLenum(format), C.GLenum(Type), values)
	}
	...
	glc.GetHistogramParameterfv = func(target, pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetHistogramParameterfv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}
	...
	glc.GetHistogramParameteriv = func(target, pname Enum, params *int32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetHistogramParameteriv(glc.context, C.GLenum(target), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.GetSeparableFilter = func(target, format, Type Enum, row, column, span unsafe.Pointer) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetSeparableFilter(glc.context, C.GLenum(target), C.GLenum(format), C.GLenum(Type), row, column, span)
	}
	...
	glc.SeparableFilter2D = func(target, internalformat Enum, width, height int32, format, Type Enum, row, column unsafe.Pointer) {
		...
		defer glc.trace(fmtCall)
		C.gl21SeparableFilter2D(glc.context, C.GLenum(target), C.GLenum(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLenum(Type), row, column)
	}

	glc.BlendColor = func(red, green, blue, alpha float32) {
		fmtCall := fmt.Sprintf("BlendColor(%v, %v, %v, %v)", red, green, blue, alpha)
		defer glc.trace(fmtCall)
		C.gl21BlendColor(glc.context, C.GLclampf(red), C.GLclampf(green), C.GLclampf(blue), C.GLclampf(alpha))
	}
	...
	glc.DrawRangeElements = func(mode Enum, start, end uint32, count int32, Type Enum, indices unsafe.Pointer) {
		...
		defer glc.trace(fmtCall)
		C.gl21DrawRangeElements(glc.context, C.GLenum(mode), C.GLuint(start), C.GLuint(end), C.GLsizei(count), C.GLenum(Type), indices)
	}
	...
	glc.TexImage3D = func(target Enum, level, internalformat int32, width, height, depth int32, border int32, format, Type Enum, pixels unsafe.Pointer) {
		...
		defer glc.trace(fmtCall)
		C.gl21TexImage3D(glc.context, C.GLenum(target), C.GLint(level), C.GLint(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLint(border), C.GLenum(format), C.GLenum(Type), pixels)
	}
	...
	glc.TexSubImage3D = func(target Enum, level, xoffset, yoffset, zoffset int32, width, height, depth int32, format, Type Enum, pixels unsafe.Pointer) {
		...
		defer glc.trace(fmtCall)
		C.gl21TexSubImage3D(glc.context, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLint(yoffset), C.GLint(zoffset), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLenum(format), C.GLenum(Type), pixels)
	}
	...
	glc.MultiDrawArrays = func(mode Enum, first *int32, count *int32, primcount int32) {
		...
		defer glc.trace(fmtCall)
		C.gl21MultiDrawArrays(glc.context, C.GLenum(mode), (*C.GLint)(unsafe.Pointer(first)), (*C.GLsizei)(unsafe.Pointer(count)), C.GLsizei(primcount))
	}
	...
	glc.DeleteBuffers = func(n int32, buffers *uint32) {
		...
		defer glc.trace(fmtCall)
		C.gl21DeleteBuffers(glc.context, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(buffers)))
	}

	glc.DeleteQueries = func(n int32, ids *uint32) {
		fmtCall := fmt.Sprintf("DeleteQueries(%v, %v)", n, ids)
		defer glc.trace(fmtCall)
		C.gl21DeleteQueries(glc.context, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(ids)))
	}

	glc.GenBuffers = func(n int32, buffers *uint32) {
		fmtCall := fmt.Sprintf("GenBuffers(%v, %v)", n, buffers)
		defer glc.trace(fmtCall)
		C.gl21GenBuffers(glc.context, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(buffers)))
	}

	glc.GenQueries = func(n int32, ids *uint32) {
		fmtCall := fmt.Sprintf("GenQueries(%v, %v)", n, ids)
		defer glc.trace(fmtCall)
		C.gl21GenQueries(glc.context, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(ids)))
	}
	...
	glc.GetBufferParameteriv = func(target, value Enum, data *int32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetBufferParameteriv(glc.context, C.GLenum(target), C.GLenum(value), (*C.GLint)(unsafe.Pointer(data)))
	}
	...
	glc.GetBufferPointerv = func(target, pname Enum, params unsafe.Pointer) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetBufferPointerv(glc.context, C.GLenum(target), C.GLenum(pname), params)
	}
	...
	glc.GetActiveAttrib = func(program, index uint32, bufSize int32) (length int32, size int32, Type Enum, name string) {
		...
		C.gl21GetActiveAttrib(glc.context, C.GLuint(program), C.GLuint(index), C.GLsizei(bufSize), (*C.GLsizei)(unsafe.Pointer(&length)), (*C.GLint)(unsafe.Pointer(&size)), (*C.GLenum)(unsafe.Pointer(&Type)), &cname)
	...
	glc.GetActiveUniform = func(program, index uint32, bufSize int32, length *int32, size *int32, Type *Enum, name *byte) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetActiveUniform(glc.context, C.GLuint(program), C.GLuint(index), C.GLsizei(bufSize), (*C.GLsizei)(unsafe.Pointer(length)), (*C.GLint)(unsafe.Pointer(size)), (*C.GLenum)(unsafe.Pointer(Type)), (*C.GLchar)(unsafe.Pointer(name)))
	}
	...
	glc.GetAttachedShaders = func(program uint32, maxCount int32, count *int32, shaders *uint32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetAttachedShaders(glc.context, C.GLuint(program), C.GLsizei(maxCount), (*C.GLsizei)(unsafe.Pointer(count)), (*C.GLuint)(unsafe.Pointer(shaders)))
	}

	glc.GetAttribLocation = func(program uint32, name *byte) int32 {
		fmtCall := fmt.Sprintf("GetAttribLocation(%v, %v)", program, name)
		defer glc.trace(fmtCall)
		return int32(C.gl21GetAttribLocation(glc.context, C.GLuint(program), (*C.GLchar)(unsafe.Pointer(name))))
	}

	glc.GetProgramiv = func(program uint32, pname Enum, params *int32) {
		fmtCall := fmt.Sprintf("GetProgramiv(%v, %v, %v)", program, pname, params)
		defer glc.trace(fmtCall)
		C.gl21GetProgramiv(glc.context, C.GLuint(program), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.GetProgramInfoLog = func(program uint32, maxLength int32, length *int32, infoLog *byte) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetProgramInfoLog(glc.context, C.GLuint(program), C.GLsizei(maxLength), (*C.GLsizei)(unsafe.Pointer(length)), (*C.GLchar)(unsafe.Pointer(infoLog)))
	}

	glc.GetShaderiv = func(program uint32, pname Enum, params *int32) {
		fmtCall := fmt.Sprintf("GetShaderiv(%v, %v, %v)", program, pname, params)
		defer glc.trace(fmtCall)
		C.gl21GetShaderiv(glc.context, C.GLuint(program), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.GetShaderInfoLog = func(shader uint32, maxLength int32, length *int32, infoLog *byte) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetShaderInfoLog(glc.context, C.GLuint(shader), C.GLsizei(maxLength), (*C.GLsizei)(unsafe.Pointer(length)), (*C.GLchar)(unsafe.Pointer(infoLog)))
	}
	...
	glc.GetShaderSource = func(shader uint32, bufSize int32, length *int32, source *byte) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetShaderSource(glc.context, C.GLuint(shader), C.GLsizei(bufSize), (*C.GLsizei)(unsafe.Pointer(length)), (*C.GLchar)(unsafe.Pointer(source)))
	}
	...
	glc.GetUniformfv = func(program uint32, location int32, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetUniformfv(glc.context, C.GLuint(program), C.GLint(location), (*C.GLfloat)(unsafe.Pointer(params)))
	}
	...
	glc.GetUniformiv = func(program uint32, location int32, params *int32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetUniformiv(glc.context, C.GLuint(program), C.GLint(location), (*C.GLint)(unsafe.Pointer(params)))
	}

	glc.GetUniformLocation = func(program uint32, name *byte) int32 {
		fmtCall := fmt.Sprintf("GetUniformLocation(%v, %v)", program, name)
		defer glc.trace(fmtCall)
		return int32(C.gl21GetUniformLocation(glc.context, C.GLuint(program), (*C.GLchar)(unsafe.Pointer(name))))
	}
	...
	glc.GetVertexAttribdv = func(index uint32, pname Enum, params *float64) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetVertexAttribdv(glc.context, C.GLuint(index), C.GLenum(pname), (*C.GLdouble)(unsafe.Pointer(params)))
	}
	...
	glc.GetVertexAttribfv = func(index uint32, pname Enum, params *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetVertexAttribfv(glc.context, C.GLuint(index), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(params)))
	}
	...
	glc.GetVertexAttribiv = func(index uint32, pname Enum, params *int32) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetVertexAttribiv(glc.context, C.GLuint(index), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(params)))
	}
	...
	glc.GetVertexAttribPointerv = func(index uint32, pname Enum, pointer unsafe.Pointer) {
		...
		defer glc.trace(fmtCall)
		C.gl21GetVertexAttribPointerv(glc.context, C.GLuint(index), C.GLenum(pname), pointer)
	}

	glc.IsProgram = func(program uint32) bool {
		fmtCall := fmt.Sprintf("IsProgram(%v)", program)
		defer glc.trace(fmtCall)
		return C.gl21IsProgram(glc.context, C.GLuint(program)) != 0
	}

	glc.IsShader = func(shader uint32) bool {
		fmtCall := fmt.Sprintf("IsShader(%v)", shader)
		defer glc.trace(fmtCall)
		return C.gl21IsShader(glc.context, C.GLuint(shader)) != 0
	}

	glc.LinkProgram = func(program uint32) {
		fmtCall := fmt.Sprintf("LinkProgram(%v)", program)
		defer glc.trace(fmtCall)
		C.gl21LinkProgram(glc.context, C.GLuint(program))
	}
	...
	glc.ShaderSource = func(shader uint32, count int32, string **byte, length *int32) {
		...
		defer glc.trace(fmtCall)
		C.gl21ShaderSource(glc.context, C.GLuint(shader), C.GLsizei(count), (**C.GLchar)(unsafe.Pointer(string)), (*C.GLint)(unsafe.Pointer(length)))
	}
	...
	glc.StencilFuncSeparate = func(face, Func Enum, ref int32, mask uint32) {
		...
		defer glc.trace(fmtCall)
		C.gl21StencilFuncSeparate(glc.context, C.GLenum(face), C.GLenum(Func), C.GLint(ref), C.GLuint(mask))
	}

	glc.StencilMaskSeparate = func(face Enum, mask uint32) {
		fmtCall := fmt.Sprintf("StencilMaskSeparate(%v, %v)", face, mask)
		defer glc.trace(fmtCall)
		C.gl21StencilMaskSeparate(glc.context, C.GLenum(face), C.GLuint(mask))
	}
	...
	glc.UniformMatrix2fv = func(location int32, count int32, transpose bool, value *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21UniformMatrix2fv(glc.context, C.GLint(location), C.GLsizei(count), boolToGL(transpose), (*C.GLfloat)(unsafe.Pointer(value)))
	}
	...
	glc.UniformMatrix3fv = func(location int32, count int32, transpose bool, value *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21UniformMatrix3fv(glc.context, C.GLint(location), C.GLsizei(count), boolToGL(transpose), (*C.GLfloat)(unsafe.Pointer(value)))
	}
	...
	glc.UniformMatrix4fv = func(location int32, count int32, transpose bool, value *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21UniformMatrix4fv(glc.context, C.GLint(location), C.GLsizei(count), boolToGL(transpose), (*C.GLfloat)(unsafe.Pointer(value)))
	}
	...
	glc.UniformMatrix2x3fv = func(location int32, count int32, transpose bool, value *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21UniformMatrix2x3fv(glc.context, C.GLint(location), C.GLsizei(count), boolToGL(transpose), (*C.GLfloat)(unsafe.Pointer(value)))
	}
	...
	glc.UniformMatrix3x2fv = func(location int32, count int32, transpose bool, value *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21UniformMatrix3x2fv(glc.context, C.GLint(location), C.GLsizei(count), boolToGL(transpose), (*C.GLfloat)(unsafe.Pointer(value)))
	}
	...
	glc.UniformMatrix2x4fv = func(location int32, count int32, transpose bool, value *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21UniformMatrix2x4fv(glc.context, C.GLint(location), C.GLsizei(count), boolToGL(transpose), (*C.GLfloat)(unsafe.Pointer(value)))
	}
	...
	glc.UniformMatrix4x2fv = func(location int32, count int32, transpose bool, value *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21UniformMatrix4x2fv(glc.context, C.GLint(location), C.GLsizei(count), boolToGL(transpose), (*C.GLfloat)(unsafe.Pointer(value)))
	}
	...
	glc.UniformMatrix3x4fv = func(location int32, count int32, transpose bool, value *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21UniformMatrix3x4fv(glc.context, C.GLint(location), C.GLsizei(count), boolToGL(transpose), (*C.GLfloat)(unsafe.Pointer(value)))
	}
	...
	glc.UniformMatrix4x3fv = func(location int32, count int32, transpose bool, value *float32) {
		...
		defer glc.trace(fmtCall)
		C.gl21UniformMatrix4x3fv(glc.context, C.GLint(location), C.GLsizei(count), boolToGL(transpose), (*C.GLfloat)(unsafe.Pointer(value)))
	}
