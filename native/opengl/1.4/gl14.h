...
typedef void(*gl14PTexImage3DEXT)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, GLvoid*);
...
typedef void(*gl14PTexSubImage3DEXT)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, GLvoid*);
...
typedef void(*gl14PBlendColorEXT)(GLclampf, GLclampf, GLclampf, GLclampf);
...
typedef struct {
    ...
    gl14PTexImage3DEXT fnTexImage3DEXT;
    ...
    gl14PTexSubImage3DEXT fnTexSubImage3DEXT;
    ...
    gl14PBlendColorEXT fnBlendColorEXT;
