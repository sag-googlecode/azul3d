...
typedef void(*gl14PBeginQuery)(GLenum, GLuint);
typedef void(*gl14PBindBuffer)(GLenum, GLuint);
typedef void(*gl14PBufferData)(GLenum, GLsizeiptr, GLvoid*, GLenum);
typedef void(*gl14PBufferSubData)(GLenum, GLenum, GLsizeiptr, GLvoid*);
typedef void(*gl14PDeleteBuffers)(GLsizei, GLuint*);
typedef void(*gl14PDeleteQueries)(GLsizei, GLuint*);
typedef void(*gl14PGenBuffers)(GLsizei, GLuint*);
typedef void(*gl14PGenQueries)(GLsizei, GLuint*);
typedef void(*gl14PGetBufferParameteriv)(GLenum, GLenum, GLint*);
typedef void(*gl14PGetBufferPointerv)(GLenum, GLenum, GLvoid*);
typedef void(*gl14PGetBufferSubData)(GLenum, GLintptr, GLsizeiptr, GLvoid*);
typedef void(*gl14PGetQueryObjectiv)(GLuint, GLenum, GLint*);
typedef void(*gl14PGetQueryObjectuiv)(GLuint, GLenum, GLuint*);
typedef void(*gl14PGetQueryiv)(GLenum, GLenum, GLint*);
typedef GLboolean(*gl14PIsBuffer)(GLuint);
typedef GLboolean(*gl14PIsQuery)(GLuint);
typedef GLvoid*(*gl14PMapBuffer)(GLenum, GLenum);
typedef GLboolean(*gl14PUnmapBuffer)(GLenum);
typedef void(*gl14PAttachShader)(GLuint, GLuint);
typedef void(*gl14PBindAttribLocation)(GLuint, GLuint, GLchar*);
typedef void(*gl14PBlendEquationSeperate)(GLenum, GLenum);
typedef void(*gl14PCompileShader)(GLuint);
typedef GLuint(*gl14PCreateProgram)();
typedef GLuint(*gl14PCreateShader)(GLenum);
typedef void(*gl14PDeleteProgram)(GLuint);
typedef void(*gl14PDeleteShader)(GLuint);
typedef void(*gl14PDetachShader)(GLuint, GLuint);
typedef void(*gl14PEnableVertexAttribArray)(GLuint);
typedef void(*gl14PDisableVertexAttribArray)(GLuint);
typedef void(*gl14PDrawBuffers)(GLsizei, GLenum*);
typedef void(*gl14PGetActiveAttrib)(GLuint, GLuint, GLsizei, GLsizei*, GLint*, GLenum*, GLchar*);
typedef void(*gl14PGetActiveUniform)(GLuint, GLuint, GLsizei, GLsizei*, GLint*, GLenum*, GLchar*);
typedef void(*gl14PGetAttachedShaders)(GLuint, GLsizei, GLsizei*, GLuint*);
typedef GLint(*gl14PGetAttribLocation)(GLuint, GLchar*);
typedef void(*gl14PGetProgramiv)(GLuint, GLenum, GLint*);
typedef void(*gl14PGetProgramInfoLog)(GLuint, GLsizei, GLsizei*, GLchar*);
typedef void(*gl14PGetShaderiv)(GLuint, GLenum, GLint*);
typedef void(*gl14PGetShaderInfoLog)(GLuint, GLsizei, GLsizei*, GLchar*);
typedef void(*gl14PGetShaderSource)(GLuint, GLsizei, GLsizei*, GLchar*);
typedef void(*gl14PGetUniformfv)(GLuint, GLint, GLfloat*);
typedef void(*gl14PGetUniformiv)(GLuint, GLint, GLint*);
typedef GLint(*gl14PGetUniformLocation)(GLuint, GLchar*);
typedef void(*gl14PGetVertexAttribdv)(GLuint, GLenum, GLdouble*);
typedef void(*gl14PGetVertexAttribfv)(GLuint, GLenum, GLfloat*);
typedef void(*gl14PGetVertexAttribiv)(GLuint, GLenum, GLint*);
typedef void(*gl14PGetVertexAttribPointerv)(GLuint, GLenum, GLvoid*);
typedef GLboolean(*gl14PIsProgram)(GLuint);
typedef GLboolean(*gl14PIsShader)(GLuint);
typedef void(*gl14PLinkProgram)(GLuint);
typedef void(*gl14PShaderSource)(GLuint, GLsizei, GLchar**, GLint*);
typedef void(*gl14PStencilFuncSeparate)(GLenum, GLenum, GLint, GLuint);
typedef void(*gl14PStencilMaskSeparate)(GLenum, GLuint);
typedef void(*gl14PStencilOpSeparate)(GLenum, GLenum, GLenum, GLenum);
typedef void(*gl14PUniform1f)(GLint, GLfloat);
typedef void(*gl14PUniform2f)(GLint, GLfloat, GLfloat);
typedef void(*gl14PUniform3f)(GLint, GLfloat, GLfloat, GLfloat);
typedef void(*gl14PUniform4f)(GLint, GLfloat, GLfloat, GLfloat, GLfloat);
typedef void(*gl14PUniform1i)(GLint, GLint);
typedef void(*gl14PUniform2i)(GLint, GLint, GLint);
typedef void(*gl14PUniform3i)(GLint, GLint, GLint, GLint);
typedef void(*gl14PUniform4i)(GLint, GLint, GLint, GLint, GLint);
typedef void(*gl14PUniform1ui)(GLint, GLuint);
typedef void(*gl14PUniform2ui)(GLint, GLuint, GLuint);
typedef void(*gl14PUniform3ui)(GLint, GLuint, GLuint, GLuint);
typedef void(*gl14PUniform4ui)(GLint, GLuint, GLuint, GLuint, GLuint);
typedef void(*gl14PUniform1fv)(GLint, GLsizei, GLfloat*);
typedef void(*gl14PUniform2fv)(GLint, GLsizei, GLfloat*);
typedef void(*gl14PUniform3fv)(GLint, GLsizei, GLfloat*);
typedef void(*gl14PUniform4fv)(GLint, GLsizei, GLfloat*);
typedef void(*gl14PUniform1iv)(GLint, GLsizei, GLint*);
typedef void(*gl14PUniform2iv)(GLint, GLsizei, GLint*);
typedef void(*gl14PUniform3iv)(GLint, GLsizei, GLint*);
typedef void(*gl14PUniform4iv)(GLint, GLsizei, GLint*);
typedef void(*gl14PUniform1uiv)(GLint, GLsizei, GLuint*);
typedef void(*gl14PUniform2uiv)(GLint, GLsizei, GLuint*);
typedef void(*gl14PUniform3uiv)(GLint, GLsizei, GLuint*);
typedef void(*gl14PUniform4uiv)(GLint, GLsizei, GLuint*);
typedef void(*gl14PUseProgram)(GLuint);
typedef void(*gl14PValidateProgram)(GLuint);
typedef void(*gl14PVertexAttribPointer)(GLuint, GLint, GLenum, GLboolean, GLsizei, GLvoid*);
typedef void(*gl14PVertexAttrib1f)(GLuint, GLfloat);
typedef void(*gl14PVertexAttrib1s)(GLuint, GLshort);
typedef void(*gl14PVertexAttrib1d)(GLuint, GLdouble);
typedef void(*gl14PVertexAttrib2f)(GLuint, GLfloat, GLfloat);
typedef void(*gl14PVertexAttrib2s)(GLuint, GLshort, GLshort);
typedef void(*gl14PVertexAttrib2d)(GLuint, GLdouble, GLdouble);
typedef void(*gl14PVertexAttrib3f)(GLuint, GLfloat, GLfloat, GLfloat);
typedef void(*gl14PVertexAttrib3s)(GLuint, GLshort, GLshort, GLshort);
typedef void(*gl14PVertexAttrib3d)(GLuint, GLdouble, GLdouble, GLdouble);
typedef void(*gl14PVertexAttrib4f)(GLuint, GLfloat, GLfloat, GLfloat, GLfloat);
typedef void(*gl14PVertexAttrib4s)(GLuint, GLshort, GLshort, GLshort, GLshort);
typedef void(*gl14PVertexAttrib4d)(GLuint, GLdouble, GLdouble, GLdouble, GLdouble);
typedef void(*gl14PVertexAttrib4Nuv)(GLuint, GLubyte, GLubyte, GLubyte, GLubyte);
typedef void(*gl14PVertexAttrib1fv)(GLuint, GLfloat*);
typedef void(*gl14PVertexAttrib1sv)(GLuint, GLshort*);
typedef void(*gl14PVertexAttrib1dv)(GLuint, GLdouble*);
typedef void(*gl14PVertexAttrib2fv)(GLuint, GLfloat*);
typedef void(*gl14PVertexAttrib2sv)(GLuint, GLshort*);
typedef void(*gl14PVertexAttrib2dv)(GLuint, GLdouble*);
typedef void(*gl14PVertexAttrib3fv)(GLuint, GLfloat*);
typedef void(*gl14PVertexAttrib3sv)(GLuint, GLshort*);
typedef void(*gl14PVertexAttrib3dv)(GLuint, GLdouble*);
typedef void(*gl14PVertexAttrib4fv)(GLuint, GLfloat*);
typedef void(*gl14PVertexAttrib4sv)(GLuint, GLshort*);
typedef void(*gl14PVertexAttrib4dv)(GLuint, GLdouble*);
typedef void(*gl14PVertexAttrib4iv)(GLuint, GLint*);
typedef void(*gl14PVertexAttrib4bv)(GLuint, GLbyte*);
typedef void(*gl14PVertexAttrib4ubv)(GLuint, GLubyte*);
typedef void(*gl14PVertexAttrib4usv)(GLuint, GLushort*);
typedef void(*gl14PVertexAttrib4uiv)(GLuint, GLuint*);
typedef void(*gl14PVertexAttrib4Nbv)(GLuint, GLbyte*);
typedef void(*gl14PVertexAttrib4Nsv)(GLuint, GLshort*);
typedef void(*gl14PVertexAttrib4Niv)(GLuint, GLint*);
typedef void(*gl14PVertexAttrib4Nubv)(GLuint, GLubyte*);
typedef void(*gl14PVertexAttrib4Nusv)(GLuint, GLushort*);
typedef void(*gl14PVertexAttrib4Nuiv)(GLuint, GLuint*);
typedef void(*gl14PUniformMatrix2fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl14PUniformMatrix3fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl14PUniformMatrix4fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl14PUniformMatrix2x3fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl14PUniformMatrix3x2fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl14PUniformMatrix2x4fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl14PUniformMatrix4x2fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl14PUniformMatrix3x4fv)(GLint, GLsizei, GLboolean, GLfloat*);
typedef void(*gl14PUniformMatrix4x3fv)(GLint, GLsizei, GLboolean, GLfloat*);
...
typedef struct {
    ...
    gl14PBeginQuery fnBeginQuery;
    gl14PBindBuffer fnBindBuffer;
    gl14PBufferData fnBufferData;
    gl14PBufferSubData fnBufferSubData;
    gl14PDeleteBuffers fnDeleteBuffers;
    gl14PDeleteQueries fnDeleteQueries;
    gl14PGenBuffers fnGenBuffers;
    gl14PGenQueries fnGenQueries;
    gl14PGetBufferParameteriv fnGetBufferParameteriv;
    gl14PGetBufferPointerv fnGetBufferPointerv;
    gl14PGetBufferSubData fnGetBufferSubData;
    gl14PGetQueryObjectiv fnGetQueryObjectiv;
    gl14PGetQueryObjectuiv fnGetQueryObjectuiv;
    gl14PGetQueryiv fnGetQueryiv;
    gl14PIsBuffer fnIsBuffer;
    gl14PIsQuery fnIsQuery;
    gl14PMapBuffer fnMapBuffer;
    gl14PUnmapBuffer fnUnmapBuffer;
    gl14PAttachShader fnAttachShader;
    gl14PBindAttribLocation fnBindAttribLocation;
    gl14PBlendEquationSeperate fnBlendEquationSeperate;
    gl14PCompileShader fnCompileShader;
    gl14PCreateProgram fnCreateProgram;
    gl14PCreateShader fnCreateShader;
    gl14PDeleteProgram fnDeleteProgram;
    gl14PDeleteShader fnDeleteShader;
    gl14PDetachShader fnDetachShader;
    gl14PEnableVertexAttribArray fnEnableVertexAttribArray;
    gl14PDisableVertexAttribArray fnDisableVertexAttribArray;
    gl14PDrawBuffers fnDrawBuffers;
    gl14PGetActiveAttrib fnGetActiveAttrib;
    gl14PGetActiveUniform fnGetActiveUniform;
    gl14PGetAttachedShaders fnGetAttachedShaders;
    gl14PGetAttribLocation fnGetAttribLocation;
    gl14PGetProgramiv fnGetProgramiv;
    gl14PGetProgramInfoLog fnGetProgramInfoLog;
    gl14PGetShaderiv fnGetShaderiv;
    gl14PGetShaderInfoLog fnGetShaderInfoLog;
    gl14PGetShaderSource fnGetShaderSource;
    gl14PGetUniformfv fnGetUniformfv;
    gl14PGetUniformiv fnGetUniformiv;
    gl14PGetUniformLocation fnGetUniformLocation;
    gl14PGetVertexAttribdv fnGetVertexAttribdv;
    gl14PGetVertexAttribfv fnGetVertexAttribfv;
    gl14PGetVertexAttribiv fnGetVertexAttribiv;
    gl14PGetVertexAttribPointerv fnGetVertexAttribPointerv;
    gl14PIsProgram fnIsProgram;
    gl14PIsShader fnIsShader;
    gl14PLinkProgram fnLinkProgram;
    gl14PShaderSource fnShaderSource;
    gl14PStencilFuncSeparate fnStencilFuncSeparate;
    gl14PStencilMaskSeparate fnStencilMaskSeparate;
    gl14PStencilOpSeparate fnStencilOpSeparate;
    gl14PUniform1f fnUniform1f;
    gl14PUniform2f fnUniform2f;
    gl14PUniform3f fnUniform3f;
    gl14PUniform4f fnUniform4f;
    gl14PUniform1i fnUniform1i;
    gl14PUniform2i fnUniform2i;
    gl14PUniform3i fnUniform3i;
    gl14PUniform4i fnUniform4i;
    gl14PUniform1ui fnUniform1ui;
    gl14PUniform2ui fnUniform2ui;
    gl14PUniform3ui fnUniform3ui;
    gl14PUniform4ui fnUniform4ui;
    gl14PUniform1fv fnUniform1fv;
    gl14PUniform2fv fnUniform2fv;
    gl14PUniform3fv fnUniform3fv;
    gl14PUniform4fv fnUniform4fv;
    gl14PUniform1iv fnUniform1iv;
    gl14PUniform2iv fnUniform2iv;
    gl14PUniform3iv fnUniform3iv;
    gl14PUniform4iv fnUniform4iv;
    gl14PUniform1uiv fnUniform1uiv;
    gl14PUniform2uiv fnUniform2uiv;
    gl14PUniform3uiv fnUniform3uiv;
    gl14PUniform4uiv fnUniform4uiv;
    gl14PUseProgram fnUseProgram;
    gl14PValidateProgram fnValidateProgram;
    gl14PVertexAttribPointer fnVertexAttribPointer;
    gl14PVertexAttrib1f fnVertexAttrib1f;
    gl14PVertexAttrib1s fnVertexAttrib1s;
    gl14PVertexAttrib1d fnVertexAttrib1d;
    gl14PVertexAttrib2f fnVertexAttrib2f;
    gl14PVertexAttrib2s fnVertexAttrib2s;
    gl14PVertexAttrib2d fnVertexAttrib2d;
    gl14PVertexAttrib3f fnVertexAttrib3f;
    gl14PVertexAttrib3s fnVertexAttrib3s;
    gl14PVertexAttrib3d fnVertexAttrib3d;
    gl14PVertexAttrib4f fnVertexAttrib4f;
    gl14PVertexAttrib4s fnVertexAttrib4s;
    gl14PVertexAttrib4d fnVertexAttrib4d;
    gl14PVertexAttrib4Nuv fnVertexAttrib4Nuv;
    gl14PVertexAttrib1fv fnVertexAttrib1fv;
    gl14PVertexAttrib1sv fnVertexAttrib1sv;
    gl14PVertexAttrib1dv fnVertexAttrib1dv;
    gl14PVertexAttrib2fv fnVertexAttrib2fv;
    gl14PVertexAttrib2sv fnVertexAttrib2sv;
    gl14PVertexAttrib2dv fnVertexAttrib2dv;
    gl14PVertexAttrib3fv fnVertexAttrib3fv;
    gl14PVertexAttrib3sv fnVertexAttrib3sv;
    gl14PVertexAttrib3dv fnVertexAttrib3dv;
    gl14PVertexAttrib4fv fnVertexAttrib4fv;
    gl14PVertexAttrib4sv fnVertexAttrib4sv;
    gl14PVertexAttrib4dv fnVertexAttrib4dv;
    gl14PVertexAttrib4iv fnVertexAttrib4iv;
    gl14PVertexAttrib4bv fnVertexAttrib4bv;
    gl14PVertexAttrib4ubv fnVertexAttrib4ubv;
    gl14PVertexAttrib4usv fnVertexAttrib4usv;
    gl14PVertexAttrib4uiv fnVertexAttrib4uiv;
    gl14PVertexAttrib4Nbv fnVertexAttrib4Nbv;
    gl14PVertexAttrib4Nsv fnVertexAttrib4Nsv;
    gl14PVertexAttrib4Niv fnVertexAttrib4Niv;
    gl14PVertexAttrib4Nubv fnVertexAttrib4Nubv;
    gl14PVertexAttrib4Nusv fnVertexAttrib4Nusv;
    gl14PVertexAttrib4Nuiv fnVertexAttrib4Nuiv;
    gl14PUniformMatrix2fv fnUniformMatrix2fv;
    gl14PUniformMatrix3fv fnUniformMatrix3fv;
    gl14PUniformMatrix4fv fnUniformMatrix4fv;
    gl14PUniformMatrix2x3fv fnUniformMatrix2x3fv;
    gl14PUniformMatrix3x2fv fnUniformMatrix3x2fv;
    gl14PUniformMatrix2x4fv fnUniformMatrix2x4fv;
    gl14PUniformMatrix4x2fv fnUniformMatrix4x2fv;
    gl14PUniformMatrix3x4fv fnUniformMatrix3x4fv;
    gl14PUniformMatrix4x3fv fnUniformMatrix4x3fv;
} gl14Context;
