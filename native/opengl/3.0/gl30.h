...
typedef void(*gl30PTexImage3DEXT)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, GLvoid*);
...
typedef void(*gl30PTexSubImage3DEXT)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, GLvoid*);
...
typedef void(*gl30PBlendColorEXT)(GLclampf, GLclampf, GLclampf, GLclampf);
...
typedef struct {
    ...
    gl30PTexImage3DEXT fnTexImage3DEXT;
    ...
    gl30PTexSubImage3DEXT fnTexSubImage3DEXT;
    ...
    gl30PBlendColorEXT fnBlendColorEXT;
